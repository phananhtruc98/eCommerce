                        ...
                        <div>
                            <asp:ListView ID="lvColoSize" runat="server" OnItemCommand="lvColoSize_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label runat="server" ID="lbSizeName" Text='<%# Eval("Size.SizeName") %>'></asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:LinkButton ValidationGroup="InsertQty" runat="server" ID="ltbnThem" CommandName="Sel" CommandArgument="<%# Container.DataItemIndex %>">
                                                <i class="fas fa-arrow-right"></i>
                                            </asp:LinkButton>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="lblKl"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:LinkButton runat="server" ID="lbtnDelete" CommandName="Del" CommandArgument="<%# Container.DataItemIndex %>">
