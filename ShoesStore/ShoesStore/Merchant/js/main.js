...
*/
    $(function() {
        $(".indicator--trigger--click .indicator__button").on("click",
            function(event) {
        ...
        $(".indicator--trigger--click .drop-search__input").on("keydown",
            function(event) {
                if (event.which === 27) {
...
*/
    $(function() {
        $(".product-tabs").each(function(i, element) {
            $(".product-tabs__list", element).on("click",
                ".product-tabs__item",
                function(event) {
                    event.preventDefault();
...
*/
    $(function() {
        $(".nav-panel__nav-links .nav-links__item").on("mouseenter",
            function() {
...
*/
    $(function() {
        ...
        if (mobileSearch.length) {
            $(".indicator--mobile-search .indicator__button").on("click",
                function() {
            ...
            mobileSearch.find(".mobile-header__search-button--close").on("click",
                function() {
                    mobileSearch.removeClass("mobile-header__search--opened");
                });
...
*/
        const CDepartments = function(element) {
            ...
            $(".departments__links-wrapper", this.element).on("transitionend",
                function(event) {
...
*/
    $(function() {
        $(".block-posts").each(function() {
            ...
            $(this).find(".block-header__arrow--left").on("click",
                function() {
                    owl.trigger("prev.owl.carousel", [500]);
                });
            $(this).find(".block-header__arrow--right").on("click",
                function() {
            ...
            const timeout = setTimeout(function() {
                    xhr = $.ajax({
                        ...
                        success: function(data) {
                            ...
                            modal.find(".quickview__close").on("click",
                                function() {
                                    modal.modal("hide");
                                });
                            modal.modal("show");
...
// timeout ONLY_FOR_DEMO!
    ...
    $(function() {
        ...
        $(".product-card__quickview").on("click",
            function() {
...
*/
    $(function() {
        $(".block-products-carousel").each(function() {
            ...
            $(this).find(".block-header__group").on("click",
                function(event) {
...
/*** this is ONLY_FOR_DEMO! / end */
                            ...
                            $(".product-card__quickview", block).on("click",
                                function() {
                                    quickview.clickHandler.apply(this, arguments);
                                });
    ...
    const initProductGallery = function(element, layout) {
        ...
        carousel
            .on("initialized.owl.carousel",
                function() {
                    carousel.find(".product-gallery__carousel-item").eq(0)
...
*/
    $(function() {
        $('[name="checkout_payment_method"]').on("change",
            function() {
        ...
        $(".payment-methods__item-container").on("transitionend",
            function(event) {
                if (event.originalEvent.propertyName === "height") {
                    $(this).css("height", "");
                }
        ...
        $("[data-collapse]").each(function(i, element) {
            ...
            $("[data-collapse-trigger]", collapse).on("click",
                function() {
                    ...
                    itemParents.slice(0, itemParents.index(collapse) + 1).filter("[data-collapse-item]")
                        .css("height", "");
            ...
            $("[data-collapse-content]", collapse).on("transitionend",
                function(event) {
                    if (event.originalEvent.propertyName === "height") {
                        $(this).css("height", "");
                    }
...
*/
    $(function() {
        ...
        if (mobilemenu.length) {
            ...
            $(".mobile-header__menu-button").on("click",
                function() {
                    open();
                });
            $(".mobilemenu__backdrop, .mobilemenu__close").on("click",
                function() {
                    close();
                });
        }
...
*/
    $(function() {
        $(".layout-switcher__button").on("click",
            function() {
