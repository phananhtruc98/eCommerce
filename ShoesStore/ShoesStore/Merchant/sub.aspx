<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sub.aspx.cs" Inherits="ShoesStore.Merchant.sub" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input id="track-order-id" type="text" class="form-control" placeholder="Order ID"></div>
                                            <div class="form-group">
                                                <label for="track-email">Email address</label>
                                                <input id="track-email" type="email" class="form-control" placeholder="Email address"></div>
                                            <div class="form-group">
                                                <label>Default</label>
                                            ...
                                            <div class="pt-3">
                                                <button type="submit" class="btn btn-primary btn-lg btn-block">Chọn Mua</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
