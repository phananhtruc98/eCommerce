                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                ...
                                <asp:Label runat="server" ID="lbProName" Text="<%# Item.RcptSubId %>"></asp:Label>
                            </td>
                            <td>
                                <asp:ListView ID="lvEachSub" runat="server" ItemType="ShoesStore.DataAccessLogicLayer.RcptSubDet">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label runat="server" ID="lbDurday" Text="<%# Item.Quantity * Item.Sub.DurDay %>"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label runat="server" ID="lbPrice" Text="<%# Item.Sub.Price %>"></asp:Label>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
                            ...
                            <td>
                                <asp:Label runat="server" ID="lbPrice" Text="<%# Item.Rcpt.DateAdd %>"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ID="lbSumDay" Text="<%# MyLibrary.RcptSub_BUS.SumDayRcptSub(Item.Rcpt, Item.MerId.Value) %>"></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" ID="lbSumPrice" Text="<%# MyLibrary.RcptSub_BUS.SumPriceRcptSub(Item.Rcpt, Item.MerId.Value) %>"></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
