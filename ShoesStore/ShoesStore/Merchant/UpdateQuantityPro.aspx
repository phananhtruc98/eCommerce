                            ...
                            <asp:ListView ID="lvSizeColorQty" ItemType="ShoesStore.DataAccessLogicLayer.ProDet" runat="server" OnItemCommand="lvSizeColorQty_ItemCommand" OnItemUpdating="lvSizeColorQty_ItemUpdating">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="lbQty" TextMode="Number" min="1" Text="<%# Item.Qty %>"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:LinkButton runat="server" ID="btnUpdateQty" Text="Cập nhật" CssClass="btn btn-primary" CommandName="Update" CommandArgument='<%#  $"{Item.SizeId},{Item.ColorId},{Item.ProId},{Item.ShpId}" %>'></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
