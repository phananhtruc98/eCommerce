...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    ...
    <div  class="row1">
        <div class="col-12 ">
            <asp:GridView ID="gvRcptBuy" ShowFooter="True" runat="server" OnRowCommand="gvBuy_RowCommand" AutoGeneratedColumns="false" BackColor="White" Width="300px" Overflow="auto" BorderColor="#CC9966" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" AllowPaging="True" Style="margin-top: 0px" OnSelectedIndexChanged="gvRcptBuy_SelectedIndexChanged">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lblSelect" CommandArgument='<%# Eval("RcptId") %>' CommandName="Select" ForeColor="#8C4510" runat="server">Chọn</asp:LinkButton>
                            <asp:LinkButton ID="lbEdit" CommandArgument='<%# Eval("RcptId") %>' CommandName="EditRow" ForeColor="#8C4510" runat="server">Sửa</asp:LinkButton>
                            
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:LinkButton ID="lbUpdate" CommandArgument='<%# Eval("RcptId") %>' CommandName="UpdateRow" ForeColor="#8C4510" runat="server">Cập nhật</asp:LinkButton>
                            <asp:LinkButton ID="lbCancel" CommandArgument='<%# Eval("RcptId") %>' CommandName="CancelUpdate" ForeColor="#8C4510" runat="server" CausesValidation="false">Hủy</asp:LinkButton>
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Mã hóa đơn">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="rcptbuyid" Text='<%# Eval("RcptId") %>' />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-Width="30px" HeaderText="Người thêm">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-Width="40px" HeaderText="Người chỉnh sửa">
                        <ItemTemplate>
                            <%# Eval("UsrEdit") %>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox Width="40px" runat="server" ID="EditUsrEdit" Text='<%# Bind("UsrEdit") %>' />
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-Width="40px" HeaderText="Người mua">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox Width="100%" runat="server" ID="EditCusId" Text='<%# Bind("CusId") %>' />
                        </EditItemTemplate>
