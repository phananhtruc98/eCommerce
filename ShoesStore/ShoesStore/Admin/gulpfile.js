...
gulp.task("bundleVendors",
    function() {
        runSequence("copyRecursiveVendorFiles",
...
gulp.task("copyRecursiveVendorFiles",
    function() {
...
gulp.task("buildBaseVendorScripts",
    function() {
        return gulp.src([
...
gulp.task("buildBaseVendorStyles",
    function() {
...
gulp.task("buildOptionalVendorScripts",
    function() {
        return gulp.src([
