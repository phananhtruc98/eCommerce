   ...
   <div class="btn btn-lg custom_bar">Danh sách quản trị viên</div>
    <div class="row">
        <div class="col-12 table-responsive">
            <asp:GridView ID="gvMerchant" ShowFooter="True" runat="server" AutoGeneratedColumns="false" BackColor="White" BorderColor="#CC9966" BorderWidth="1px" CellPadding="4" OnRowCommand="gvSub_RowCommand" BorderStyle="None"  AutoGenerateColumns="False" AllowPaging="True" style="margin-top: 0px">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
