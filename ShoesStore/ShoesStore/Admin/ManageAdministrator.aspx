    ...
    <div class="container">
        <div class="row">
            <div class="col-12 table-responsive">
                <asp:GridView ID="gvAdmin" ShowFooter="True" runat="server" AutoGeneratedColumns="true" BackColor="White" BorderColor="#CC9966" BorderWidth="1px" CellPadding="4" BorderStyle="None" AutoGenerateColumns="False" AllowPaging="True" Style="margin-top: 0" AllowSorting="True" OnSorting="gvAdmin_Sorting" OnRowCommand="gvAdmin_RowCommand" OnRowDataBound="gvAdmin_RowDataBound">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Chức vụ" SortExpression="RoleName">
                            <ItemTemplate>
                                <asp:Label Text='<%# Eval("RoleName") %>' runat="server" ID="RoleName_Present" />
                                <asp:Label Text='<%# Eval("RoleId") %>' runat="server" ID="RoleID_Present" Visible="false" />
                            </ItemTemplate>
                            <FooterTemplate>
