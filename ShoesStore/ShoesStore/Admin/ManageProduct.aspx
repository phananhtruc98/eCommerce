    ...
    <div class="container">
        <div class="row">
            <div class="col-12 table-responsive">
                Bảng sản phẩm
                <asp:GridView ID="gvPro" class="custom_table" runat="server" AutoGeneratedColumns="false" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowPaging="True" OnPageIndexChanging="gvPro_PageIndexChanging" PageSize="5">
                    <Columns>
                       <%-- <asp:TemplateField>
                            <ItemTemplate>
