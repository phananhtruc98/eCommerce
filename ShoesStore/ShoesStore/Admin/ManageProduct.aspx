    ...
    <div class="container">
        <div class="row">
            <div class="col-12 table-responsive">
                Bảng sản phẩm
                <asp:GridView ID="gvPro" class="custom_table" ShowFooter="True" runat="server" AutoGeneratedColumns="false" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowPaging="True" OnPageIndexChanging="gvPro_PageIndexChanging" PageSize="1">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Tên cửa hàng">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" ID="EditShpName" Text='<%# Bind("ShpName") %>' />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox runat="server" ID="InsertShpName" Text=' <%# Bind("ShpName") %>' />
                                <asp:RequiredFieldValidator ID="rfvEditShpName"
                                    runat="server"
                                    ErrorMessage="Chưa nhập tên màu"
                                    ControlToValidate="InsertShpName"
                                    Text="*" ForeColor="Red" ValidationGroup="Insert">
                                </asp:RequiredFieldValidator>
                            </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Còn hàng">
                            ...
                            <EditItemTemplate>
                                <asp:CheckBox runat="server" ID="EditIsOutOfStock" Checked='<%# Bind("IsOutOfStock") %>' />
                            </EditItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Ảnh">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" ID="EditImg" Text='<%# Bind("Img") %>' />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox runat="server" ID="InsertImg" Text=' <%# Bind("Img") %>' />
                                <asp:RequiredFieldValidator ID="rfvEditImg"
                                    runat="server"
                                    ErrorMessage="Chưa nhập tên màu"
                                    ControlToValidate="InsertImg"
                                    Text="*" ForeColor="Red" ValidationGroup="Insert">
                                </asp:RequiredFieldValidator>
                            </FooterTemplate>
                        </asp:TemplateField>
                    ...
                    <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast" NextPageText="Next" PageButtonCount="3" PreviousPageText="Previous" />
