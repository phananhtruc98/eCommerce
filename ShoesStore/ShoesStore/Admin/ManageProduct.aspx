...
<HeaderStyle />
        ...
        <div class="row">
            <div class="col-12 table-responsive">
                Bảng kích cỡ giày
        <asp:GridView ID="gvProSize" class="custom_table" runat="server"  ShowFooter="true" AutoGeneratedColumns="false" BorderWidth="1px" AutoGenerateColumns="False" Width="353px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" CellPadding="4">
            <Columns>
                <asp:TemplateField>
<ItemTemplate>
