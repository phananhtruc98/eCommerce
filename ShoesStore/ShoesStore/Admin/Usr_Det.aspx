                        ...
                        <div>
                            <table class="table table-bordered">
                                <tr>
                                    <td>Ảnh đại diện</td>
                                    <td>
                                       <asp:Image CssClass="rounded"  runat="server" Style="width: 300px; height: 300px" ID="avatar" /></td>
                                </tr>
                                <tr>
                                    <td>Mã người dùng </td>
                                    <td>
                                        <asp:Label runat="server" ID="lbUsrId"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Loại người dùng</td>
                                    <td>
                                        <asp:Label runat="server" ID="lbUsrType"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Tên người dùng</td>
                                    <td>
                                        <asp:Label runat="server" ID="lbUsrName"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Địa chỉ</td>
                                    <td>
                                        <asp:Label runat="server" ID="lbAddress"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Số điện thoại</td>
                                    <td>
                                ...
                                <tr>
                                    <td>Ngày sửa</td>
                                    <td>
                                        <asp:Label runat="server" ID="lbDateEdit"></asp:Label></td>
                                </tr>
                            </table>
                        </div>
                    </div>
