        ...
        <div class="row">
            <asp:ListView runat="server" OnItemDataBound="lvRcptBuy_ItemDataBound" OnPagePropertiesChanging="lvRcptBuy_PagePropertiesChanging" AllowPaging="true" ItemType="ShoesStore.DataAccessLogicLayer.RcptBuy" OnItemCommand="lvRcptBuy_ItemCommand" OnSelectedIndexChanged="lvRcptBuy_SelectedIndexChanged" ID="lvRcptBuy">
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            <asp:LinkButton runat="server" ID="lbtnDetail" CommandName="Sel" CommandArgument="<%# Item.RcptBuyId %>" CssClass="btn btn-icons btn-rounded btn-outline-warning">
                                <i class="fas fa-info"></i>
                            </asp:LinkButton>
                        </td>

                        <td>
                            <asp:Label runat="server" ID="lbRcptId" Text="<%# Item.RcptBuyId %>"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCusName" Text="<%# Item.Cus.Usr.UsrName %>"></asp:Label>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
