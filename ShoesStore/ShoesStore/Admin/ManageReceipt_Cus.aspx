...
<div class="row">
    <div class="col-12 table-responsive">
        <asp:GridView ID="gvRcptBuy" ShowFooter="True" runat="server" OnRowCommand="gvBuy_RowCommand" AutoGeneratedColumns="false" BackColor="White" BorderColor="#CC9966" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" AllowPaging="True" Style="margin-top: 0px" OnSelectedIndexChanged="gvRcptBuy_SelectedIndexChanged">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
