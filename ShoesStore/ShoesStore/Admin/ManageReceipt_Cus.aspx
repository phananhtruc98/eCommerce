...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--<div class="row">
        <div class="col-12 table-responsive">
            <asp:GridView ID="gvRcptBuy" ShowFooter="True" ItemType="ShoesStore.DataAccessLogicLayer.RcptBuy" runat="server" OnRowCommand="gvBuy_RowCommand" AutoGeneratedColumns="false" BackColor="White" BorderColor="#CC9966" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" AllowPaging="True" Style="margin-top: 0px" OnSelectedIndexChanged="gvRcptBuy_SelectedIndexChanged">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lblSelect" CommandArgument='<%# Item.RcptBuyId %>' CommandName="Select" ForeColor="#8C4510" runat="server">Chọn</asp:LinkButton>
                    ...
                    <asp:TemplateField HeaderText="Mã hóa đơn">
                        ...
                        <FooterTemplate>
                            <asp:Label runat="server" type="number" ID="InsertBuyId" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Người thêm">
                        ...
                        <FooterTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="rfvEditUsrAdd" runat="server" ErrorMessage="Chưa nhập người thêm" ControlToValidate="InsertUsrAdd" Text="*" ForeColor="Red" ValidationGroup="Insert">
                    ...
                    <asp:TemplateField HeaderText="Người mua">
                        <ItemTemplate>
                            <%# Eval("CusId") %>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox runat="server" ID="EditCusId" Text='<%# Bind("CusId") %>' />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox runat="server" ID="InsertCusId" Text=' <%# Bind("CusId") %>' />
                        </FooterTemplate>
                    </asp:TemplateField>
                </Columns>
