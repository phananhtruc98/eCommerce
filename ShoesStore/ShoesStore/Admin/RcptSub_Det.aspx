                ...
                <tbody>
                    <asp:ListView ID="lvRcptSubDet" runat="server" OnItemDataBound="lvRcptSubDet_ItemDataBound" ItemType="ShoesStore.DataAccessLogicLayer.RcptSubDet" >
                        ...
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:LinkButton runat="server" ID="lbtnDetail" CommandName="Detail" CommandArgument='<%# Item.SubId %>' CssClass="btn btn-icons btn-rounded btn-outline-warning"><i class="fas fa-info"></i></asp:LinkButton></td>
                                <td>
                                    <asp:Label runat="server" ID="lbCusId" Text="<%# Item.Sub.SubContent %>"></asp:Label></td>
                                <td>
                                    <asp:Label runat="server" ID="lbUsrName" Text="<%# Item.Quantity %>"></asp:Label></td>
                                <td>
                                    <asp:Label runat="server" ID="lbEmail" Text="<%# Item.Quantity*Item.Sub.DurDay %>"></asp:Label></td>
                                <td>
                                    <asp:Label runat="server" ID="lbDateAdd" Text="<%# double.Parse(Item.Quantity.ToString()) * double.Parse(Item.Sub.Price) %>"></asp:Label></td>
                            </tr>
                        </ItemTemplate>
                    </asp:ListView>
                    <tr>
