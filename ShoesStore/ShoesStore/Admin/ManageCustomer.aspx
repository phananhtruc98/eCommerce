            ...
            <div class="col-12 table-responsive">
                <asp:ListView runat="server" ID="lvCus" OnItemCommand="lvCus_ItemCommand" ItemType="ShoesStore.DataAccessLogicLayer.Cus">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:LinkButton runat="server" ID="lbtnDetail" CommandName="Detail" CommandArgument='<%# Item.CusId %>' CssClass="btn btn-icons btn-rounded btn-outline-warning"><i class="fas fa-info"></i></asp:LinkButton></td>
                            <td>
                                <asp:Label runat="server" ID="lbCusId" Text="<%# Item.CusId %>"></asp:Label></td>
                            <td>
