...
<div class="row">
    <div class="col-12 table-responsive">
        <asp:GridView ID="gvCustomer" ShowFooter="True" runat="server" AutoGeneratedColumns="false" BackColor="White" BorderColor="#CC9966" BorderWidth="1px" CellPadding="2" BorderStyle="None" AutoGenerateColumns="False" AllowPaging="True" style="margin-top: 0px">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
