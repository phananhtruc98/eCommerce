                    ...
                    tokenize: function(text, grammar, language) {
                        ...
                        tokenloop: for (var token in grammar) {
                            ...
                            for (var j = 0; j < patterns.length; ++j) {
                                ...
                                for (var i = 0;
                                    i < strarr.length;
                                    i++) { // Don’t cache length as it changes during the loop
                                    var str = strarr[i];
...
// Todo: use a proper css loader here
                    ...
                    editor.on("PreProcess",
                        function(e) {
                            $("pre[contenteditable=false]", e.node).filter(trimArg(Utils.isCodeSample)).each(
                                function(idx, elm) {
...
// Needs to be textContent since innerText produces BR:s
                    ...
                    editor.on("SetContent",
                        function() {
                            var unprocessedCodeSamples = $("pre").filter(trimArg(Utils.isCodeSample)).filter(
                                function(idx, elm) {
