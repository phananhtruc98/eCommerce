    ...
    define(
        ...
        function(Tools, NodeType) {
            var getSelectedListItems = function(editor) {
                return Tools.grep(editor.selection.getSelectedBlocks(),
                    function(block) {
...
// Append OL/UL to previous LI if it's in a parent OL/UL i.e. old HTML4
            ...
            var normalizeLists = function(dom, element) {
                Tools.each(Tools.grep(dom.select("ol,ul", element)),
                    function(ul) {
...
// Resolve node index
                ...
                Tools.each(siblings,
                    function(node) {
                        ...
                        if (BookmarkManager.isBookmarkNode(node)) {
                            if (NodeType.isTextBlock(editor, nextSibling) ||
            ...
            var applyList = function(editor, listName, detail) {
                ...
                Tools.each(getSelectedTextBlocks(editor, rng),
                    function(block) {
            ...
            var removeList = function(editor) {
                ...
                var emptyListItems = Tools.grep(listItems,
                    function(li) {
                        return editor.dom.isEmpty(li);
                    });
                listItems = Tools.grep(listItems,
                    function(li) {
                        return !editor.dom.isEmpty(li);
                    });
                Tools.each(emptyListItems,
                    function(li) {
                            ...
                            editor.on("nodechange",
                                function() {
                                    ...
                                    for (var i = 0, l = blocks.length; !disable && i < l; i++) {
                                        ...
                                        disable = (tag === "LI" && NodeType.isFirstChild(blocks[i]) ||
                                            tag === "UL" ||
                                            tag === "OL" ||
                                            tag === "DD");
                                    }
