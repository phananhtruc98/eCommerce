            ...
            PluginManager.add("template",
                function(editor) {
                    ...
                    function replaceTemplateValues(html, templateValuesOptionName) {
                        Tools.each(editor.getParam(templateValuesOptionName),
                            function(v, k) {
...
// Find template element within div
                        ...
                        Tools.each(dom.select("*", el),
                            function(n) {
// Replace cdate
                                if (hasClass(n,
                                    editor.getParam("template_cdate_classes", "cdate").replace(/\s+/g, "|"))) {
                                    n.innerHTML = getDateTime(editor.getParam("template_cdate_format",
                                        editor.getLang("template.cdate_format")));
                                }
// Replace mdate
                                if (hasClass(n,
                                    editor.getParam("template_mdate_classes", "mdate").replace(/\s+/g, "|"))) {
                                    n.innerHTML = getDateTime(editor.getParam("template_mdate_format",
...
// Replace selection
                    ...
                    editor.on("PreProcess",
                        function(o) {
                            var dom = editor.dom;
                            Tools.each(dom.select("div", o.node),
                                function(e) {
                                        ...
                                        Tools.each(dom.select("*", e),
                                            function(e) {
                                                if (dom.hasClass(e,
                                                    ...
                                                    .replace(/\s+/g, "|"))) {
                                                    e.innerHTML = getDateTime(editor.getParam("template_mdate_format",
                                                        editor.getLang("template.mdate_format")));
                                                }
                                            });
                                        replaceVals(e);
