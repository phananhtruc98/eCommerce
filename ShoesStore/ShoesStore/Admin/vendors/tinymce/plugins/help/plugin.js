    ...
    define(
        ...
        function(Arr, KeyboardShortcuts) {
            var makeTab = function() {
                ...
                var shortcutLisString = Arr.map(KeyboardShortcuts.shortcuts,
                    function(shortcut) {
    ...
    define(
        ...
        function(tinymce, Obj, Arr, Fun, Strings, PluginUrls) {
            var maybeUrlize = function(name) {
                return Arr.find(PluginUrls.urls,
                    function(x) {
                        return x === name;
                    }).fold(Fun.constant(name),
                    function(pluginName) {
    ...
    define(
        ...
        function(EditorManager) {
            ...
            var makeRow = function() {
                ...
                var changeLogLink = '<a href="https://www.tinymce.com/docs/changelog/" target="_blank">TinyMCE ' +
                    version +
                    "</a>";
                return [
                    {
                ...
                return function() {
                    editor.windowManager.open({
                        ...
                        onPostRender: function() {
                            ...
                            title.innerHTML =
                                '<img src="' + url + '/img/logo.png" alt="TinyMCE Logo" style="width: 200px">';
                        }
                    });
                };
            };
