                        ...
                        start: function(name, attrs, empty) {
                            ...
                            for (var i = 0; i < attrs.length; i++) {
                                ...
                                if (attrs[i].name === "style") {
                                    attrs[i].value =
                                        editor.dom.serializeStyle(editor.dom.parseStyle(attrs[i].value), name);
                                }
                            }
            ...
            var placeHolderConverter = function(editor) {
                return function(nodes) {
                    ...
                    while (i--) {
                        ...
                        if (node.name === "script") {
                            videoScript =
                                VideoScript.getVideoScriptMatch(editor.settings.media_scripts, node.attr("src"));
                            if (!videoScript) {
                                continue;
                            }
                        }
    ...
    define(
        ...
        function(Mime, HtmlToData, UrlPatterns, VideoScript, UpdateHtml, Tools) {
            var dataToHtml = function(editor, dataIn) {
                ...
                Tools.each(UrlPatterns.urlPatterns,
                    function(pattern) {
                        var i;
                        var url;
        ...
        function(Delay, HtmlToData, UpdateHtml, Service, Size, Tools, Env, SizeManager) {
            ...
            var getData = function(editor) {
                ...
                return element.getAttribute("data-mce-object")
                    ? HtmlToData.htmlToData(editor.settings.media_scripts,
            ...
            var addEmbedHtml = function(win, editor) {
                return function(response) {
                    ...
                    var data = Tools.extend(HtmlToData.htmlToData(editor.settings.media_scripts, html),
...
// Make sure that any messy HTML is retained inside these
                        ...
                        Tools.each("video audio iframe object".split(" "),
                            function(name) {
...
// Set allowFullscreen attribs as boolean
                        ...
                        Tools.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "),
                            function(name) {
                                boolAttrs[name] = {};
                            });
