            ...
            PluginManager.add("advlist",
                function(editor) {
                    ...
                    function buildMenuItems(listName, styleValues) {
                        var items = [];
                        if (styleValues) {
                            Tools.each(styleValues.split(/[ ,]/),
                                function(styleValue) {
                                    items.push({
                                        text: styleValue.replace(/\-/g, " ").replace(/\b\w/g,
                                            function(chr) {
                    ...
                    olMenuItems = buildMenuItems("OL",
                        editor.getParam(
                            "advlist_number_styles",
                            "default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman"
                        ));
                    ulMenuItems = buildMenuItems("UL",
...
// Switch/add list type if needed
                            ...
                            list = dom.getParent(sel.getNode(), "ol,ul");
                            if (list) {
                                Tools.each(dom.select("ol,ul", list).concat([list]),
                                    function(list) {
                    ...
                    function updateSelection(e) {
                        var listStyleType =
                            editor.dom.getStyle(editor.dom.getParent(editor.selection.getNode(), "ol,ul"),
                                    "listStyleType") ||
                                "";
