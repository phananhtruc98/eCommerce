        ...
        function(Tools, Factory, DOMUtils, Toolbar, Forms, Measure, Layout, EditorSettings) {
            return function() {
                ...
                var repositionPanelAt = function(panel, id, editor, targetRect) {
                    ...
                    userConstainHandler =
                        EditorSettings.getHandlerOr(editor, "inline_toolbar_position_handler", Layout.defaultHandler);
                ...
                var showForm = function(editor, id) {
                    if (panel) {
                        ...
                        userConstainHandler = EditorSettings.getHandlerOr(editor,
    ...
    define(
        ...
        function(
            ...
            var bindContextualToolbarsEvents = function(editor, panel) {
                ...
                var throttledTogglePanelWhenNotInForm =
                    Delay.throttle(ignoreWhenFormIsVisible(editor, panel, togglePanel(editor, panel)), 0);
