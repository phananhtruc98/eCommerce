                    ...
                    function(item) {
                        ...
                        var bindSelectorChanged = function() {
                            ...
                            if (item.settings.stateSelector) {
                                selection.selectorChanged(item.settings.stateSelector,
                                    function(state) {
                                        item.active(state);
                                    },
                                    true);
                            ...
                            if (item.settings.disabledStateSelector) {
                                selection.selectorChanged(item.settings.disabledStateSelector,
                                    function(state) {
                                        item.disabled(state);
                                    });
                            }
    ...
    define(
        ...
        function(DOMUtils, Tools, Delay, Factory, Rect, Toolbar) {
            ...
            var hideAllFloatingPanels = function(editor) {
                Tools.each(editor.contextToolbars,
                    function(toolbar) {
                        if (toolbar.panel) {
                            toolbar.panel.hide();
                        }
...
// Allow overflow below the editor to avoid placing toolbars ontop of tables
                        ...
                        if (elementRect) {
                            relPos = Rect.findBestRelativePosition(panelRect,
                                elementRect,
                                contentAreaRect,
                                [
                                    "bc-tc", "bl-tl", "br-tr"
...
//drawRect(panelRect, 'green');
                ...
                editor.on("click keyup setContent ObjectResized",
                    function(e) {
...
// Added though context
            ...
            var createMenuButtons = function(editor) {
                ...
                var enabledMenuNames = typeof settings.menubar == "string"
    ...
    define(
        ...
        function(Tools, Factory, Env) {
            ...
            var createSidebar = function(editor) {
                var buttons = Tools.map(editor.sidebars,
                    function(sidebar) {
...
// TODO: This is kind of ugly and doesn't handle multiple scrollable elements
                        ...
                        panel.fixed(false).moveRel(body, editor.rtl ? ["tr-br", "br-tr"] : ["tl-bl", "bl-tl", "tr-br"])
