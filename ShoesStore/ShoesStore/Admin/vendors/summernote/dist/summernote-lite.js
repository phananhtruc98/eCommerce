    ...
    var modal = (function() {
        var Modal = function($node, options) {
            ...
            this.show = function() {
                ...
                this.$modal.off("click", ".close").on("click",
                    ".close",
                    function() {
                        self.hide();
                    });
...
// set button type
    ...
    var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check">',
        function($node, options) {
            var markup = $.isArray(options.items)
                ? options.items.map(function(item) {
                    var value = (typeof item === "string") ? item : (item.value || "");
...
// replace empty heading, pre or custom-made styleTag with P tag
                    if ((dom.isHeading(nextPara) || dom.isPre(nextPara) || dom.isCustomStyleTag(nextPara)) &&
...
* @param {enum} whereWhere change will be applied Row or Col. Use enum: TableResultAction.where
...
* setting color
*
* @param {Object} sObjColorcolor code
...
*/
        this.addTablePopoverButtons = function() {
            ...
            context.memo("button.addRowDown",
                function() {
                    return ui.button({
                        className: "btn-md",
            ...
            context.memo("button.addColLeft",
                function() {
                    return ui.button({
                        className: "btn-md",
            ...
            context.memo("button.addColRight",
                function() {
                    return ui.button({
                        className: "btn-md",
            ...
            context.memo("button.deleteTable",
                function() {
                    return ui.button({
                        className: "btn-md",
                        contents: ui.icon(options.icons.trash),
    ...
    var LinkDialog = function(context) {
        ...
        this.initialize = function() {
            ...
            var body = '<div class="form-group note-form-group">' +
                ...
                ' note-form-controlnote-input" type="text" />' +
                "</div>" +
    ...
    var VideoDialog = function(context) {
        ...
        this.initialize = function() {
            ...
            var body = '<div class="form-group note-form-group row-fluid">' +
                ...
                "</small></label>" +
                '<input class="note-video-url form-controlnote-form-control note-input span12" ' +
                ' type="text" />' +
                "</div>";
            var footer = '<button href="#" class="btn btn-primary note-btn note-btn-primary ' +
