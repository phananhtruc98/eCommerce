define("ace/mode/doc_comment_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/java_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            f = function() {
                var e =
                    ...
                    i = function(e) {
                        return[
                            { token: "comment", regex: "\\/\\/.*$" }, o.getStartRule("doc-start"),
                ...
                }, this.embedRules(o, "doc-", [o.getEndRule("start")]), this.embedRules(s,
                    "java-",
                    [
    ...
    function(e, t, n) {
        ...
        r.inherits(u, s), function() {
            this.foldingStartMarker = /\b(rule|declare|query|when|then)\b/, this.foldingStopMarker =
                /\bend\b/, this.getFoldWidgetRange = function(e, t, n) {
                        ...
                        while (c) {
                            if (c.value == l)
                                return i.fromPoints(a,
                                    { row: f.getCurrentTokenRow(), column: f.getCurrentTokenColumn() });
                            c = f.stepForward()
                        }
                    }
                }
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/drools_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() { this.lineCommentStart = "//", this.$id = "ace/mode/drools" }.call(u.prototype),
            t.Mode = u
    });
(function() {
    window.require(["ace/mode/drools"],
        function(m) {
