        ...
        var r = e("../lib/oop"),
            ...
            u = function() {
                this.$rules = {
                    start: [
                        {
                            ...
                            onMatch: function(e, t, n) {
                                ...
                                var s,
                                    ...
                                    a = 0,
                                    f = [
                                        { value: r[a++] + "'", type: "text" }, { value: u = r[a++], type: "text" },
                                        { value: "'" + r[a++], type: "text" }
                                    ];
                                r[2] !== " in" &&
                                        f.push({ value: "'" + r[a++] + "'", type: "text" },
                                            { value: r[a++], type: "text" }),
                                    f.push({ value: " " + r[a++] + " ", type: "text" }), r[a + 1]
                    ...
                    numbers: [
                        { regex: "\\d+", token: "constant.numeric" }, { regex: "$", token: "text", next: "start" }
                    ]
                }, this.normalizeRules()
            };
...
(function() {
    window.require(["ace/mode/c9search"],
        function(m) {
