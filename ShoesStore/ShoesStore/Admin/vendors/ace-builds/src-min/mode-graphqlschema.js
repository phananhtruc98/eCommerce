define("ace/mode/graphqlschema_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                ...
                {
                    start: [
                        { token: "comment", regex: "#.*$" }, { token: "paren.lparen", regex: /[\[({]/, next: "start" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/graphqlschema_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i),
            function() { this.lineCommentStart = "#", this.$id = "ace/mode/graphqlschema" }.call(u.prototype), t.Mode =
                u
    });
(function() {
    window.require(["ace/mode/graphqlschema"],
        function(m) {
