define("ace/mode/abc_highlight_rules",
    ...
    function(e, t, n) {
            ...
            s = function() {
                this.$rules = {
                    start: [
                        {
                            token: [
                                "zupfnoter.information.comment.line.percentage", "information.keyword",
        ...
        s.metaData =
            { fileTypes: ["abc"], name: "ABC", scopeName: "text.abcnotation" }, r.inherits(s, i), t.ABCHighlightRules =
            s
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/abc_highlight_rules",
