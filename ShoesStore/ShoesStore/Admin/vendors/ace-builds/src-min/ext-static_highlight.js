define("ace/ext/static_highlight",
    ...
    function(e, t, n) {
        ...
        f.render = function(e, t, n, i, s, u) {
            ...
            typeof n == "string" && (a++, o.loadModule(["theme", n], function(e) { n = e, --a || h() }));
            var c;
            return t && typeof t == "object" && !t.getTokenizer && (c = t, t = c.path), typeof t == "string" &&
            (a++, o.loadModule(["mode", t],
                function(e) {
...
(function() {
    window.require(["ace/ext/static_highlight"],
        function(m) {
