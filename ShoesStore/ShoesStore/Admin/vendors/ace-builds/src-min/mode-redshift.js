define("ace/mode/doc_comment_highlight_rules",
    ...
    [
        ...
        "ace/mode/text_highlight_rules", "ace/mode/json_highlight_rules"
    ],
    function(e, t, n) {
        var r = e("../lib/oop"),
            i = e("../lib/lang"),
            ...
            a = function() {
                ...
                this.$rules =
                {
                    ...
                    commentStatement:
                    [
                        { token: "comment", regex: ".*?\\*\\/", next: "statement" }, { token: "comment", regex: ".+" }
                    ],
                    commentDollarSql:
                    [
                        { token: "comment", regex: ".*?\\*\\/", next: "dollarSql" }, { token: "comment", regex: ".+" }
                    ],
                ...
                }, this.embedRules(s, "doc-", [s.getEndRule("start")]), this.embedRules(u,
                    "json-",
...
(function() {
    window.require(["ace/mode/redshift"],
        function(m) {
