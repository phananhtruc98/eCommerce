define("ace/mode/ada_highlight_rules",
    ...
    ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ada_highlight_rules"],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            i = e("./text").Mode,
        ...
        r.inherits(o, i), function() { this.lineCommentStart = "--", this.$id = "ace/mode/ada" }.call(o.prototype),
            t.Mode = o
    });
(function() {
    window.require(["ace/mode/ada"],
        function(m) {
