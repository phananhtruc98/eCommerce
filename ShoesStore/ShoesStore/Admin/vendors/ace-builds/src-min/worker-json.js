...
!function(e) {
    ...
    function(e, t, n) {
        ...
        var r,
            ...
            s = { '"': '"', "\\": "\\", "/": "/", b: "\b", f: "\f", n: "\n", r: "\r", t: "	" },
            o,
            u = function(e) { throw{ name: "SyntaxError", message: e, at: r, text: o } },
            a = function(e) {
            ...
            v = function() {
                ...
                if (i === "{") {
                    ...
                    if (i === "}") return a("}"), t;
                    while (i) {
                        e = l(), c(), a(":"), Object.hasOwnProperty.call(t, e) && u('Duplicate key "' + e + '"'), t[e] =
                            p(), c();
                        if (i === "}") return a("}"), t;
                        a(","), c()
                    }
        ...
        return p = function() {
            ...
            var n;
            return o = e, r = 0, i = " ", n = p(), c(), i && u("Syntax error"), typeof t == "function"
                ? function s(e, n) {
                    var r, i, o = e[n];
