    ...
    function(e, t, n) {
        ...
        var r = e("ace/lib/dom"),
            ...
            s = function(e, t) {
                ...
                var n = i.delayedCall(function() { this.updateStatus(e) }.bind(this)).schedule.bind(null, 100);
        ...
        (function() {
            this.updateStatus = function(e) {
                ...
                n(i.row + ":" + i.column, " "), r.rangeCount && n("[" + r.rangeCount + "]", " "), t.pop(), this.element
                    .textContent = t.join("")
            }
        }).call(s.prototype), t.StatusBar = s
    });
(function() {
    window.require(["ace/ext/statusbar"],
        function(m) {
