define("ace/ext/whitespace",
    ...
    function(e, t, n) {
        ...
        t.$detectIndentation = function(e, t) {
            ...
            for (var u = 1; u < 12; u++) {
                var v = c(u);
                u == 1 ? (d = v, v = n[1] ? .9 : .8, n.length || (v = 0)) : v /= d, r[u] && (v += r[u] / h),
            ...
            for (var a = 0, f = r.length; a < f; a++) {
                ...
                a == u && (c < s[o].column && c > i && (c = s[o].column), o++, u = s[o] ? s[o].row : -1), c > i &&
                    n.removeInLine(a, c, l.length)
            }
...
(function() {
    window.require(["ace/ext/whitespace"],
        function(m) {
