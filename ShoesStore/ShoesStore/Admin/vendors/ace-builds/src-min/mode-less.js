define("ace/mode/css_highlight_rules",
    ...
    [
        ...
        "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/css_completions",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            l = function() {
                this.HighlightRules = s, this.$outdent = new o, this.$behaviour = new u, this.$completer =
                    new a, this.foldingRules = new f
            };
