define("ace/mode/pig_highlight_rules",
    ...
    function(e, t, n) {
        ...
        s.metaData =
            { fileTypes: ["pig"], name: "Pig", scopeName: "source.pig" }, r.inherits(s, i), t.PigHighlightRules = s
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/pig_highlight_rules",
