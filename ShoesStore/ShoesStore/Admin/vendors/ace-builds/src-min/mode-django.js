define("ace/mode/doc_comment_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/html_highlight_rules",
        "ace/mode/text_highlight_rules"
    ],
    function(e, t, n) {
        var r = e("../lib/oop"),
            ...
            u = function() {
                this.$rules = {
                    start: [
                        ...
                        { token: "constant", regex: "[0-9]+" }, { token: "variable", regex: "[-_a-zA-Z0-9:]+" }
                    ],
        ...
        r.inherits(a, s);
        var f = function() { i.call(this), this.HighlightRules = a };
        r.inherits(f, i), function() { this.$id = "ace/mode/django" }.call(f.prototype), t.Mode = f
    });
(function() {
    window.require(["ace/mode/django"],
        function(m) {
