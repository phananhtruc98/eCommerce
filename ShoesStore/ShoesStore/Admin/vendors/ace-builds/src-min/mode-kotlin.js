define("ace/mode/kotlin_highlight_rules",
    ...
    function(e, t, n) {
            ...
            s = function() {
                this.$rules = {
                                ...
                                },
                                {
                                    ...
                                    push: [
                                        ...
                                        { token: "entity.other.inherited-class.kotlin", regex: /\w+/ },
                                        {
                                            ...
                                            regex: /\(/,
                                            push: [
                                                { token: "text", regex: /\)/, next: "pop" }, { include: "#expressions" }
                                            ]
                                        }
                                    ]
                                },
                    ...
                    [
                        ...
                        {
                            token: [
                                "text", "punctuation.definition.comment.kotlin", "comment.line.double-slash.kotlin"
                            ],
                            regex: /(\s*)(\/\/)(.*$)/
                        }
                    ],
                    ...
                    [
                        ...
                        }, { include: "#types" }, { include: "#strings" }, { include: "#constants" },
                        { include: "#comments" }, { include: "#keywords" }
                    ],
                    "#functions":
                    [
                        {
                    ...
                    "#statements":
                    [
                        { include: "#namespaces" }, { include: "#typedefs" }, { include: "#classes" },
                        { include: "#functions" }, { include: "#variables" }, { include: "#getters-and-setters" },
                        { include: "#expressions" }
                    ],
                    "#strings":
                    [
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            push: [
                                { token: "text", regex: />/, next: "pop" }, { include: "#types" },
                                { include: "#keywords" }
                            ]
                        },
                        {
        ...
        s.metaData =
            { fileTypes: ["kt", "kts"], name: "Kotlin", scopeName: "source.Kotlin" }, r.inherits(s, i), t
            .KotlinHighlightRules = s
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/kotlin_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            a = function() { this.HighlightRules = s, this.foldingRules = new u, this.$behaviour = new o };
        r.inherits(a, i), function() { this.$id = "ace/mode/kotlin" }.call(a.prototype), t.Mode = a
    });
(function() {
    window.require(["ace/mode/kotlin"],
        function(m) {
