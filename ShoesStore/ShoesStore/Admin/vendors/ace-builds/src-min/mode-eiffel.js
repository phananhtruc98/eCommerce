define("ace/mode/eiffel_highlight_rules",
            ...
            s = function() {
                ...
                this.$rules = {
                    ...
                    aligned_verbatim_string:
                        [{ token: "string", regex: /]"/, next: "start" }, { token: "string", regex: o }],
    ...
    function(e, t, n) {
        ...
        r.inherits(o, i), function() { this.lineCommentStart = "--", this.$id = "ace/mode/eiffel" }.call(o.prototype),
            t.Mode = o
    });
(function() {
    window.require(["ace/mode/eiffel"],
        function(m) {
