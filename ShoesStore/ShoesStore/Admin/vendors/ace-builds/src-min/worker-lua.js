...
!function(e) {
            ...
            function(e) {
                ...
                function x(e) {
                    ...
                    throw"undefined" != typeof e.line
                        ? (r = e.range[0] - e.lineStart, n = new SyntaxError(E("[%1:%2] %3", e.line, r, t)), n.line =
                            e.line, n.index = e.range[0], n.column = r)
                        : (r = C - D + 1, n = new SyntaxError(E("[%1:%2] %3", _, r, t)), n.index = C, n.line =
                            _, n.column = r), n
                }
                ...
                function B() {
                    ...
                    return e =
                        ...
                        : "nil" === e
                        ? (n = h, e = null)
                        : n = a, { type: n, value: e, line: _, lineStart: D, range: [M, C] }
                }
                ...
                function U() {
                    ...
                    if ("pP".indexOf(t.charAt(C) || null) >= 0) {
                        C++, "+-".indexOf(t.charAt(C) || null) >= 0 && (r = "+" === t.charAt(C++) ? 1 : -1), o =
                            C, Y(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C));
                ...
                function z() {
                    ...
                    if ("eE".indexOf(t.charAt(C) || null) >= 0) {
                        C++, "+-".indexOf(t.charAt(C) || null) >= 0 && C++, Y(t.charCodeAt(C)) ||
                            x({}, d.malformedNumber, t.slice(M, C));
                        while (Y(t.charCodeAt(C))) C++
                    }
                ...
                function Mt() {
                    var e = [], t, n, r;
                    mt && (r = vt[vt.length - 1], vt.push(r)), t = qt(), K("then"), n =
                        St(), e.push(m(v.ifClause(t, n))), mt && (r = gt());
                    while (J("elseif"))
                        wt(r), t = qt(), K("then"), n = St(), e.push(m(v.elseifClause(t, n))), mt && (r = gt());
                    return J("else") && (mt && (r = new yt(L), vt.push(r)), n = St(), e.push(m(v.elseClause(n)))),
                        K("end"), m(v.ifStatement(e))
                }
                    ...
                    for (;;)
                        if (l === k.type)
                            ...
                            case".":
                                ...
                                break;
                            case":":
                                wt(r), $(), u = Ht(), n.scope && pt(u, i), e =
                                    m(v.memberExpression(e, ":", u)), wt(r), e = Wt(e);
                                break;
                            case"(":
                            case"{":
                                wt(r), e = Wt(e);
                ...
                function Vt(s, o) {
                    return"undefined" == typeof o && "object" == typeof s && (o = s, s = undefined), o || (o = {}), t =
                        s || "", n = S(i, o), C = 0, _ = 1, D = 0, r = t.length, ot = [[]], ut = 0, at = [], vt =
                        [], n.comments && (O = []), n.wait ? e : Jt()
                }
                ...
                var d = e.errors =
                    ...
                    v = e.ast = {
                        labelStatement: function(e) { return{ type: "LabelStatement", label: e } },
                        breakStatement: function() { return{ type: "BreakStatement" } },
                        gotoStatement: function(e) { return{ type: "GotoStatement", label: e } },
                        returnStatement: function(e) { return{ type: "ReturnStatement", arguments: e } },
                        ifStatement: function(e) { return{ type: "IfStatement", clauses: e } },
                        ifClause: function(e, t) { return{ type: "IfClause", condition: e, body: t } },
                        elseifClause: function(e, t) { return{ type: "ElseifClause", condition: e, body: t } },
                        elseClause: function(e) { return{ type: "ElseClause", body: e } },
                        whileStatement: function(e, t) { return{ type: "WhileStatement", condition: e, body: t } },
                        doStatement: function(e) { return{ type: "DoStatement", body: e } },
                        repeatStatement: function(e, t) { return{ type: "RepeatStatement", condition: e, body: t } },
                        localStatement: function(e, t) { return{ type: "LocalStatement", variables: e, init: t } },
                        assignmentStatement:
                            function(e, t) { return{ type: "AssignmentStatement", variables: e, init: t } },
                        callStatement: function(e) { return{ type: "CallStatement", expression: e } },
                        functionStatement:
                            function(e, t, n, r) {
                        ...
                        chunk: function(e) { return{ type: "Chunk", body: e } },
                        identifier: function(e) { return{ type: "Identifier", name: e } },
                        literal: function(e, t, n) {
                            return e = e === o
                                ...
                                : e === h
                                ? "NilLiteral"
                                : "VarargLiteral", { type: e, value: t, raw: n }
                        },
                        tableKey: function(e, t) { return{ type: "TableKey", key: e, value: t } },
                        tableKeyString: function(e, t) { return{ type: "TableKeyString", key: e, value: t } },
                        tableValue: function(e) { return{ type: "TableValue", value: e } },
                        ...
                        tableCallExpression:
                            function(e, t) { return{ type: "TableCallExpression", base: e, arguments: t } },
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            o = t.Worker = function(e) { i.call(this, e), this.setTimeout(500) };
