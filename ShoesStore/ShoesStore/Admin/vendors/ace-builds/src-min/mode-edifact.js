define("ace/mode/doc_comment_highlight_rules",
            ...
            o = function() {
                ...
                this.$rules =
                {
                    start: [
                        ...
                        { token: o, regex: "[a-zA-Z_$][a-zA-Z0-9_$]*\\b" }, { token: "keyword.operator", regex: "\\+" },
                        { token: "punctuation.operator", regex: "\\:|'" }, { token: "identifier", regex: "\\:D\\:" }
                    ]
                }, this.embedRules(i, "doc-", [i.getEndRule("start")])
            };
        o.metaData =
                { fileTypes: ["edi"], keyEquivalent: "^~E", name: "Edifact", scopeName: "source.edifact" },
    ...
    function(e, t, n) {
        ...
        r.inherits(o, i), function() { this.$id = "ace/mode/edifact" }.call(o.prototype), t.Mode = o
    });
(function() {
    window.require(["ace/mode/edifact"],
        function(m) {
