define("ace/mode/bro_highlight_rules",
            ...
            s = function() {
                this.$rules = {
                    ...
                    [
                        ...
                        {
                            token: [
                                "meta.function.bro", "meta.function.bro", "storage.type.bro", "meta.function.bro",
                                "entity.name.function.bro", "meta.function.bro"
                            ],
                        ...
                        {
                            token: [
                                "meta.preprocessor.bro.if", "keyword.other.special-method.bro",
                    ...
                    [
                        {
                            ...
                            regex: /^\s*\@if(?:n?def)?\b.*$/,
                            push: [
                                { token: "text", regex: /^\s*\@endif\b.*$/, next: "pop" }, { include: "#disabled" },
                                { include: "#pragma-mark" }
                            ],
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/bro_highlight_rules",
