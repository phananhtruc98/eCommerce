define("ace/mode/doc_comment_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/html_highlight_rules",
        "ace/mode/text_highlight_rules"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            ...
            u = function() {
                ...
                this.$rules["twig-comment"] =
                    [{ token: "comment.block.twig", regex: ".*-?#\\}", next: "pop" }], this.$rules["twig-start"] =
                [
                ...
                [
                    ...
                    { token: "string", regex: '"', next: "twig-start" }, { defaultToken: "string" }
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/twig_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            o = e("./matching_brace_outdent").MatchingBraceOutdent,
            u = function() { i.call(this), this.HighlightRules = s, this.$outdent = new o };
        r.inherits(u, i), function() {
            this.blockComment = { start: "{#", end: "#}" }, this.getNextLineIndent = function(e, t, n) {
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/twig"
        }.call(u.prototype), t.Mode = u
    });
(function() {
    window.require(["ace/mode/twig"],
        function(m) {
