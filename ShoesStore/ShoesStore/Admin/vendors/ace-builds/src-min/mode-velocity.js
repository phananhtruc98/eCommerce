define("ace/mode/doc_comment_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            u = function() {
                ...
                var e = i.arrayToMap("true|false|null".split("|")),
                    t = i.arrayToMap(
                        "_DateTool|_DisplayTool|_EscapeTool|_FieldTool|_MathTool|_NumberTool|_SerializerTool|_SortTool|_StringTool|_XPathTool"
                        .split("|")),
                ...
                this.$rules.start.push({ token: "comment", regex: "##.*$" },
                        ...
                        { token: "lparen", regex: "[[({]" },
                        { token: "rparen", regex: "[\\])}]" },
                        { token: "text", regex: "\\s+" }), this.$rules.vm_comment =
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/velocity_highlight_rules",
...
(function() {
    window.require(["ace/mode/velocity"],
        function(m) {
