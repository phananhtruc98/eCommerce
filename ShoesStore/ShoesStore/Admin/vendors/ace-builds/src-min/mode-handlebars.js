define("ace/mode/doc_comment_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/handlebars_highlight_rules",
        "ace/mode/behaviour/html", "ace/mode/folding/html"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            ...
            a = function() { i.call(this), this.HighlightRules = s, this.$behaviour = new o };
        r.inherits(a, i), function() {
            this.blockComment = { start: "{{!--", end: "--}}" }, this.$id = "ace/mode/handlebars"
        }.call(a.prototype), t.Mode = a
    });
(function() {
    window.require(["ace/mode/handlebars"],
        function(m) {
