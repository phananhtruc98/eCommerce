define("ace/mode/doc_comment_highlight_rules",
                    ...
                    return[
                        {
                            ...
                            regex: "\\/\\/(?=.)",
                            next: [
                                s.getTagRule(), { token: "comment", regex: "$|^", next: "start" },
                        ...
                        }, s.getStartRule("doc-start"),
                        {
                            ...
                            push: [
                                s.getTagRule(), { token: "comment.start", regex: /\/\*/, push: "nested_comment" },
                        ...
                        t('"',
                            {
                                ...
                                error: /\\./,
                                multiline: !1
                            }), n(), { regex: /@[a-zA-Z_$][a-zA-Z_$\d\u0080-\ufffe]*/, token: "variable.parameter" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/swift_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            a = function() {
                this.HighlightRules = s, this.foldingRules = new u, this.$behaviour = new o, this.$behaviour =
                    this.$defaultBehaviour
            };
        r.inherits(a, i), function() {
            this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/", nestable: !0 }, this.$id =
                "ace/mode/swift"
        }.call(a.prototype), t.Mode = a
    });
(function() {
    window.require(["ace/mode/swift"],
        function(m) {
