define("ace/mode/yaml_highlight_rules",
                    ...
                    start: [
                        ...
                        { token: "string", regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' }, {
                            ...
                            onMatch: function(e, t, n, r) {
                                var i = /^\s*/.exec(r)[0];
                                return n.length < 1 ? n.push(this.next) : n[0] = "mlString", n.length < 2
                                    ? n.push(i.length)
                                    : n[1] = i.length, this.token
                            },
                            next: "mlString"
                        }, { token: "string", regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" },
                        {
                    ...
                    mlString: [
                        { token: "indent", regex: /^\s*$/ }, {
                            ...
                            onMatch: function(e, t, n) {
                                var r = n[1];
                                return r >= e.length ? (this.next = "start", n.splice(0)) : this.next = "mlString", this
                                    .token
                            },
                            next: "mlString"
                        }, { token: "string", regex: ".+" }
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            a = function() {
                this.HighlightRules = s, this.$outdent = new o, this.foldingRules = new u, this.$behaviour =
