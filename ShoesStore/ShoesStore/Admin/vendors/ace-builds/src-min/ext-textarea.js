define("ace/theme/textmate",
    ...
    function(e, t, n) {
        ...
        function c(e, t, n, r, i) {
            function u(e) { return e === "true" || e == 1 }
        ...
        t.transformTextarea = function(e, n) {
            var s = e.autofocus || document.activeElement == e, u, l = f(e, function() { return u.getValue() });
            ...
            i.isOldIE ? m.backgroundColor = "#333" : m.backgroundColor = "rgba(0, 0, 0, 0.6)", a(v, m),
                l.appendChild(v), n = n || t.defaultOptions;
            var g = o.edit(p);
            u = g.getSession(), u.setValue(e.value || e.innerHTML), s && g.focus(), l.appendChild(d), c(g, p, v, o, n),
                h(v, d, g);
            var y = "";
            return r.addListener(d,
                ...
                function(e) {
                    ...
                    r.capture(d,
                        function(e) {
                            l.style.width = e.clientX - t.left + n + "px", l.style.height =
...
(function() {
    window.require(["ace/ext/textarea"],
        function(m) {
