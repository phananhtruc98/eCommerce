define("ace/mode/doc_comment_highlight_rules",
            ...
            u = function() {
                ...
                this.$rules =
                {
                    ...
                    [
                        ...
                        { token: "support.function.C99.c", regex: o }, { token: u, regex: "[a-zA-Z_$][a-zA-Z0-9_$]*" },
                        {
        ...
        var r = e("../lib/oop"),
            ...
            u = function() {
                    ...
                    [
                        ...
                        { token: "comment", regex: "\\/\\*", next: "comment" },
                        {
                            token: [
                                ...
                                "text", "entity.other.inherited-class.objc"
                            ],
                ...
                this.$rules.bracketed_content =
                    this.$rules.bracketed_content.concat(this.$rules.start, t), this.embedRules(i,
                    "doc-",
                    [i.getEndRule("start")])
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/objectivec_highlight_rules",
...
(function() {
    window.require(["ace/mode/objectivec"],
        function(m) {
