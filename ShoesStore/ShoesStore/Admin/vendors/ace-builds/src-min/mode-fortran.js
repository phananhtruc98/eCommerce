define("ace/mode/fortran_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                ...
                this.$rules = {
                    start:
                    [
                        { token: "comment", regex: "!.*$" }, { token: "string", regex: u + '"{3}', next: "qqstring3" },
                        ...
                        { token: "constant.numeric", regex: y }, { token: "constant.numeric", regex: h + "[lL]\\b" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/fortran_highlight_rules",
        "ace/mode/folding/cstyle", "ace/range"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
...
(function() {
    window.require(["ace/mode/fortran"],
        function(m) {
