...
<%@ Import Namespace="ShoesStore.BusinessLogicLayer" %><%@ Register TagPrefix="wcCustom" Namespace="ShoesStore.WebControls" Assembly="ShoesStore" %><%@ Register Src="~/UserControls/UcPro.ascx" TagPrefix="uc1" TagName="UcPro" %><%@ MasterType VirtualPath="~/Site.Master" %>
