                                ...
                                <tr class="cart-table__row">
                                    ...
                                    <td class="cart-table__column cart-table__column--quantity" data-title="Quantity">
                                        <div class="input-number">
                                            <asp:TextBox runat="server" type="number" ID="txtQty" CssClass="form-control input-number__input" OnTextChanged="txtQty_OnTextChanged" AutoPostBack="True" min="1" value="<%# Item.Qty %>">
                                            </asp:TextBox>
...
<a href="#">Cách tính ship</a>
                                ...
                                <tr>
                                    <th>Tổng</th>
                                    <td>
                                        <asp:Literal runat="server" ID="ltrSumAll" Text="<%# MyLibrary.CartDet_BUS.SumCartDetPrice().ToFormatMoney() %>"/>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
                            <a class="btn btn-primary btn-xl btn-block cart__checkout-button" href="/gio-hang/thanh-toan">
                                Thanh toán
                            </a>
                        </div>
                    </div>
