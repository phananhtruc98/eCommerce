                    ...
                    <div class="product__content">
                        ...
                        <div class="product__info">
                            ...
                            <ul class="product__meta">
                                ...
                                <li><b>Thương hiệu</b>: <%: _proDetView.ProBrand.BrandName %></li>
                                ...
                                <asp:ListView runat="server" ID="lvColorName" ItemType="ShoesStore.DataAccessLogicLayer.ProColor">
                                    ...
                                    <ItemTemplate>
                                        <td>
                                            <div>
                                                <%# Item.ColorName %>
                                                <div style="background-color: #<%# Item.HexCode %>; border: black solid 1px; height: 32px; margin: auto; width: 32px;" />
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Literal Visible="<%# ((List<ProDet>) rptProDet.DataSource).Where(m => m.SizeId == Item.SizeId).IsFirst(Item) ? true : false %>" runat="server" ID="Size" Text="<%# Item.ProSize.SizeName %>" />
                                                    </td>
                                                    <td>
                                                        <asp:HiddenField runat="server" ID="hdfColorId" Value="<%# Item.ColorId %>" />
                                                        <div style="background-color: #<%# Item.ProColor.HexCode %>; border: black solid 1px; height: 32px; width: 32px;" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Literal runat="server" ID="IsOutOfStock" Text='<%# MyLibrary.ProDet_BUS.IsOutOfStock(Item) ? "Hết hàng" : MyLibrary.ProDet_BUS.ProDetLeft(Item) + "" %>'></asp:Literal>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                            ...
                            <div class="reviews-view">
                                <div class="reviews-view__list">
                                    ...
                                    <div class="reviews-list">
                                        ...
                                        <asp:Label runat="server" ID="lbNhanXet" Visible="False">Chưa có nhận xét nào</asp:Label> 
                                    </div>
                                </div>
