...
namespace ShoesStore
{
    public static class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapPageRoute("ManagerReceipt-Customer", "quan-tri/hoa-don-san-pham",
                "~/Admin/ManageReceipt_Cus.aspx");
            routes.MapPageRoute("ManagerReceipt-Merchant", "quan-tri/hoa-don-goi-thuong-nien",
                "~/Admin/ManageReceipt_Mer.aspx");
            ...
            routes.MapPageRoute("Overview_RcptSuccess", "quan-tri/thong-ke-don-hang-mua-sp-thanh-cong",
                "~/Admin/Overview.aspx");
            ...
            routes.MapPageRoute("Mer_Contact", "lien-he", "~/Customer/Contact.aspx");
            ...
            routes.MapPageRoute("Mer_MerProfile_ChangePassword", "nguoi-ban/doi-mat-khau",
                "~/Merchant/MerProfile_ChangePassword.aspx");
            routes.MapPageRoute("Mer_Promotion", "cua-hang/quan-ly-san-pham/khuyen-mai",
                "~/Merchant/MerPromotion.aspx");
            routes.MapPageRoute("Mer_DisableProduct", "cua-hang/quan-ly-san-pham/an-san-pham",
                "~/Merchant/DisableProduct.aspx");
            routes.MapPageRoute("Mer_UpdateQuantityPro", "cua-hang/quan-ly-san-pham/cap-nhat-so-luong-san-pham",
                "~/Merchant/UpdateQuantityPro.aspx");
            routes.MapPageRoute("Mer_ManageRcptSub", "nguoi-ban/quan-ly-sub/hoa-don-mua-goi-thuong-nien",
                "~/Merchant/ManageRcptSub.aspx");
            ...
            routes.MapPageRoute("Cushome_ChangePassword", "nguoi-dung/tai-khoan/mat-khau",
                "~/Customer/CusHome_ChangePassword.aspx");
            routes.MapPageRoute("Cushome_Comment", "nguoi-dung/tai-khoan/nhan-xet", "~/Customer/CusHome_Cmt.aspx");
            routes.MapPageRoute("Cushome_Rcpt_Success", "nguoi-dung/theo-doi-don-hang",
                "~/Customer/CusHome_RcptSuccess.aspx");
