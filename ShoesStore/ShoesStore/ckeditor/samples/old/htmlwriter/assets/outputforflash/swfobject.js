var swfobject = function() {
        ...
        if (0 < a)
            for (var b = 0; b < a; b++) {
                ...
                if (0 < e.pv[0]) {
                    ...
                    if (d)
                        if (!A(r[b].swfVersion) || e.wk && 312 > e.wk)
                            if (r[b].expressInstall && F()) {
                                ...
                                for (var h = {}, d = d.getElementsByTagName("param"), k = d.length, l = 0;
                                    l <
                                        k;
                                    l++)
                    ...
                    v(c, !0), f &&
                        ((c = H(c)) && "undefined" != typeof c.SetVariable && (g.success = !0, g.ref = c), f(g))
            }
    }
    ...
    function G(a, b, c, f) {
        ...
        if (g) {
            ...
            e.ie &&
                e.win &&
                4 != g.readyState &&
                (f = d.createElement("div"), c += "SWFObjectNew", f.setAttribute("id", c),
                    g.parentNode.insertBefore(f, g), g.style.display = "none", function() {
    ...
    function K(a, b, c) {
        ...
        if (g)
            if ("undefined" == typeof a.id &&
                ...
                g.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' +
                    q +
                    "\x3e" +
                    h +
                    "\x3c/object\x3e";
                ...
                for (q in b)
                    b[q] != Object.prototype[q] &&
                        "movie" != q.toLowerCase() &&
                        (a = k, h = q, l = b[q], c =
                            d.createElement("param"), c.setAttribute("name", h), c.setAttribute("value", l), a
                            .appendChild(c));
    ...
    function Q(a, b, c, f) {
        if (!e.ie || !e.mac) {
            ...
            g &&
            (c = c && "string" == typeof c ? c : "screen", f && (L = m = null), m && L == c ||
            (f = d.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), m =
                g.appendChild(f), e.ie &&
                e.win &&
                "undefined" != typeof d.styleSheets &&
                0 < d.styleSheets.length &&
                (m = d.styleSheets[d.styleSheets.length - 1]), L = c), e.ie && e.win
                ? m && "object" == typeof m.addRule && m.addRule(a, b)
                : m &&
                "undefined" != typeof d.createTextNode &&
                m.appendChild(d.createTextNode(a +
                    " {" +
                    b +
                    "}")))
        }
    ...
    var n = window,
        ...
        R = !0,
        e = function() {
            var a = "undefined" != typeof d.getElementById &&
            ...
            if ("undefined" != typeof t.plugins && "object" == typeof t.plugins["Shockwave Flash"])
                !(h = t.plugins["Shockwave Flash"].description) ||
                    ...
                    (T = !0, g = !1, h = h.replace(/^.*\s+(\S+\s+\S+$)/,
                        "$1"), e[0] = parseInt(h.replace(/^(.*)\..*$/, "$1"), 10), e[1] =
                        parseInt(h.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] =
                        /[a-zA-Z]/.test(h) ? parseInt(h.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
            else if ("undefined" != typeof n.ActiveXObject)
                try {
                    var k = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                    k &&
                        (h = k.GetVariable("$version")) &&
                        (g = !0, h = h.split(" ")[1].split(","), e =
                            [parseInt(h[0], 10), parseInt(h[1], 10), parseInt(h[2], 10)])
                } catch (l) {
                }
    ...
    (function() {
        ...
        (("undefined" != typeof d.readyState &&
            ...
            w(), u ||
        ("undefined" != typeof d.addEventListener && d.addEventListener("DOMContentLoaded", w, !1), e.ie &&
            e.win &&
            ...
            function() { u || (/loaded|complete/.test(d.readyState) ? w() : setTimeout(arguments.callee, 0)) }(), N(w)))
    })();
    (function() {
        e.ie &&
            e.win &&
    ...
    return{
            ...
            e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g
                ? (v(b, !1), M(function() {
                    ...
                    if (h && "object" === typeof h)
                        for (var t in h)
                            m.flashvars = "undefined" != typeof m.flashvars
        ...
        expressInstallCallback: function() {
            if (B) {
                ...
                a &&
                    y &&
                    (a.parentNode.replaceChild(y, a), C && (v(C, !0), e.ie && e.win && (y.style.display = "block")),
                        I && I(O));
                B = !1
            }
        }
