(function(q) {
    ...
    function Bd(a) {
        a.display.wrapper.className = a.display.wrapper.className.replace(/\s*cm-s-\S+/g, "") +
            a.options.theme.replace(/(^|\s)\s*/g,
                " cm-s-");
        hb(a)
    }
    ...
    function Cd(a) {
        ...
        a.display.scrollbars = new q.scrollbarModel[a.options.scrollbarStyle](function(b) {
                ...
                v(b,
                    "mousedown",
                    function() { a.state.focused && setTimeout(function() { a.display.input.focus() }, 0) });
                b.setAttribute("cm-not-content", "true")
            },
            function(b, c) { "horizontal" == c ? Ma(a, b) : lb(a, b) },
            a);
    ...
    function Na(a,
        ...
        for (var e = 0; 4 > e && c != a.display.barWidth || d != a.display.barHeight; e++)
            c != a.display.barWidth && a.options.lineWrapping && Lb(a), Jd(a, jb(a)), c = a.display.barWidth, d =
                a.display.barHeight
    }
    ...
    function Jd(a, b) {
        ...
        d.bottom && a.options.coverGutterNextToScrollbar && a.options.fixedGutter
            ? (c.gutterFiller.style.display = "block", c.gutterFiller.style.height =
                d.bottom + "px", c.gutterFiller.style.width = b.gutterWidth + "px")
    ...
    function Bc(a) {
        ...
        if (b.alignWidgets || b.gutters.firstChild && a.options.fixedGutter) {
            for (var d = Ic(b) - b.scroller.scrollLeft + a.doc.scrollLeft,
    ...
    function Lc(a, b) {
        ...
        0 == e.view.length || f >= e.viewTo || g <= e.viewFrom
            ...
            : (e.viewFrom > f
                ...
                : e.viewFrom < f && (e.view = e.view.slice(Ca(a, f))), e.viewFrom = f, e.viewTo < g
                ? e.view = e.view.concat(Nb(a, e.viewTo, g))
                : e.viewTo > g &&
                (e.view = e.view.slice(0,
                    Ca(a, g))));
        e.viewTo = g;
        ...
        if (!d &&
            ...
            !b.force &&
            c.renderedView == c.view &&
            (null == c.updateLineNumbers || c.updateLineNumbers >= c.viewTo)) return!1;
        f = fa();
        ...
        d &&
        (c.lastWrapHeight = b.wrapperHeight, c.lastWrapWidth =
    ...
    function Md(a, b) {
        for (var c = b.viewport, d = !0;; d = !1) {
            if (!d || !a.options.lineWrapping || b.oldDisplayWidth == pa(a))
                if (c && null != c.top && (c = { top: Math.min(a.doc.height + Ec(a.display) - Nc(a), c.top) }),
                    b.visible = Hc(a.display, a.doc, c), b.visible.from >= a.display.viewFrom &&
                        b.visible.to <= a.display.viewTo) break;
            if (!Lc(a, b)) break;
            Lb(a);
            d = jb(a);
            nb(a);
        ...
        if (a.display.viewFrom != a.display.reportedViewFrom || a.display.viewTo != a.display.reportedViewTo)
            b.signal(a,
                ...
                a,
                a.display.viewFrom,
                a.display.viewTo), a.display.reportedViewFrom = a.display.viewFrom, a.display.reportedViewTo =
                a.display.viewTo
    }
    ...
    function Ob(a) {
        a.node == a.text &&
        (a.node =
            t("div", null, null, "position: relative"), a.text.parentNode &&
            a.text.parentNode.replaceChild(a.node, a.text), a.node.appendChild(a.text), B &&
            8 > C &&
    ...
    function Qd(a, b, c, d) {
        ...
        if (a.options.lineNumbers || e) {
            ...
            !a.options.lineNumbers ||
                ...
                (b.lineNumber = g.appendChild(t("div",
                    Jc(a.options, c),
    ...
    function Td(a, b, c, d, e) {
        if (b.widgets) {
            ...
            for (b = b.widgets; g < b.length; ++g) {
                ...
                l.coverGutter &&
                (m.style.zIndex = 5, m.style.position =
                    "relative", l.noHScroll || (m.style.marginLeft = -p.gutterTotalWidth + "px"));
        ...
        function g(b) {
            if (1 == b.nodeType) {
                ...
                if (null != c)
                    ...
                    if (c)
                        b = a.findMarks(r(d, 0), r(e + 1, 0), f(+c)), b.length &&
                            (p = b[0].find()) &&
    ...
    function rb(a, b, c, d) {
        return a.cm && a.cm.display.shift || a.extend
            ? (a =
                b.anchor, d && (b = 0 > y(c, a), b != 0 > y(d, a) ? (a = c, c = d) : b != 0 > y(c, d) && (c = d)), new
                z(a, c))
            : new z(d || c, c)
    }
    ...
    function de(a, b) {
        b.equals(a.sel) ||
        (a.sel = b, a.cm && (a.cm.curOp.updateInput = a.cm.curOp.selectionChanged = !0, fe(a.cm)), L(a,
            "cursorActivity",
            a))
    }
        ...
        a:for (;;) {
            ...
            if (h.markedSpans)
                for (var k = 0; k < h.markedSpans.length; ++k) {
                    ...
                    if ((null == l.from || (m.inclusiveLeft ? l.from <= f.ch : l.from < f.ch)) &&
                        ...
                        if (m.atomic) {
                            ...
                            (k.ch += g, 0 > k.ch
                                ...
                                : k.ch > h.text.length &&
                                (k = k.line < a.first + a.size - 1 ? r(k.line + 1, 0) : null), !k)) {
                                if (e) {
        ...
        for (var c = a.doc,
            ...
            if (!1 !==
                ...
                if (k || a.options.showCursorWhenSelecting) {
                    ...
                    p.other &&
                    (l = m.appendChild(t("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor")), l.style.display =
                        "", l.style.left = p.other.left + "px", l.style.top = p.other.top +
    ...
    function Yc(a) {
        if (a.state.focused) {
            ...
            0 < a.options.cursorBlinkRate
                ? b.blinker =
                setInterval(function() { b.cursorDiv.style.visibility = (c = !c) ? "" : "hidden" },
        ...
        if (b.cache.hasOwnProperty(f))
            ...
            if (!b.hasHeights) {
                ...
                if (!g.measure.heights || k && g.measure.width != l) {
                    ...
                    if (k)
                        for (g.measure.width = l, g = g.text.firstChild.getClientRects(), k = 0;
                            k < g.length - 1;
                            k++) {
                            var l = g[k], p = g[k + 1];
            ...
            if (3 == d.nodeType) {
                ...
                B &&
                    ...
                    (null != bd
                        ? E = bd
                        : (m = U(a.display.measure, t("span", "x")), E = m.getBoundingClientRect(), m =
                            Ea(m, 0, 1).getBoundingClientRect(), E = bd = 1 < Math.abs(E.left - m.left)), E = !E), E ||
                    (E = screen.logicalXDPI / screen.deviceXDPI, m = screen.logicalYDPI / screen.deviceYDPI, n = {
                        left: n.left * E,
                        right: n.right * E,
                        top: n.top * m,
                        bottom: n.bottom * m
                ...
                0 < h && (c = g = "right"), n = a.options.lineWrapping && 1 < (E = d.getClientRects()).length
    ...
    function cd(a, b, c, d) {
        ...
        if ("page" == d || "window" == d)
            a = a.display.lineSpace.getBoundingClientRect(), b += a.top +
                ("window" == d
                    ? 0
                    : window.pageYOffset || (document.documentElement || document.body).scrollTop), d =
                    a.left +
                    ("window" == d ? 0 : window.pageXOffset || (document.documentElement || document.body).scrollLeft),
                c.left += d, c.right += d;
        c.top += b;
        c.bottom += b;
        return c
    ...
    function ne(a, b, c) {
        ...
        b = b.top;
        "page" == c
            ? (d -= window.pageXOffset || (document.documentElement || document.body).scrollLeft, b -=
            ...
            try {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    !f.scrollbarsClipped &&
                        ...
                        (f.nativeBarWidth =
                            f.scroller.offsetWidth - f.scroller.clientWidth, f.heightForcer.style.height =
                            da(c) + "px", f.sizer.style.marginBottom =
                            -f.nativeBarWidth + "px", f.sizer.style.borderRightWidth =
                ...
                for (b =
                        0;
                    b < a.length;
                    b++) e = a[b], e.updatedDisplay = e.mustUpdate && Lc(e.cm, e.update);
                for (b = 0; b < a.length; b++)
                    if (e = a[b], c = e.cm, d = c.display, e.updatedDisplay && Lb(c), e.barMeasure =
                        jb(c), d.maxLineChanged &&
                        !c.options.lineWrapping &&
                        (f = void 0, f = d.maxLine.text.length, f =
                            $c(c, Zb(c, d.maxLine), f, void 0), e.adjustWidthTo = f.left + 3, c.display.sizerWidth =
                            e.adjustWidthTo, e.barMeasure.scrollWidth =
                            Math.max(d.scroller.clientWidth,
                                d.sizer.offsetLeft + e.adjustWidthTo + da(c) + c.display.barWidth), e.maxScrollLeft =
                            Math.max(0,
                                d.sizer.offsetLeft +
                                e.adjustWidthTo -
                                pa(c))), e.updatedDisplay || e.selectionChanged)
                        e.preparedSelection = d.input.prepareSelection();
                for (b = 0; b < a.length; b++)
                    e = a[b], c =
                            e.cm, null != e.adjustWidthTo &&
                        (c.display.sizer.style.minWidth =
                            e.adjustWidthTo + "px", e.maxScrollLeft < c.doc.scrollLeft &&
                            Ma(c, Math.min(c.display.scroller.scrollLeft, e.maxScrollLeft), !0), c.display
                            .maxLineChanged =
                            !1), e.preparedSelection && c.display.input.showSelection(e.preparedSelection),
                        e.updatedDisplay && Oc(c, e.barMeasure), (e.updatedDisplay || e.startHeight != c.doc.height) &&
                            Na(c, e.barMeasure), e.selectionChanged && Yc(c), c.state.focused &&
                            e.updateInput &&
                            c.display.input.reset(e.typing), e.focus && e.focus == fa() && Ud(e.cm);
                for (b = 0; b < a.length; b++) {
                    e = a[b];
                    c = e.cm;
                    d = c.display;
                    ...
                    null == e.scrollLeft ||
                        ...
                        (f.scrollLeft =
                                Math.max(0, Math.min(d.scroller.scrollWidth - pa(c), e.scrollLeft)),
                            d.scrollbars.setScrollLeft(f.scrollLeft), d.scroller.scrollLeft = f.scrollLeft, Bc(c));
                    if (e.scrollToPos) {
                        var g = void 0,
                        ...
                        e.scrollToPos.isCursor &&
                            ...
                            (k = c.display, l = k.sizer.getBoundingClientRect(), h = null, 0 > g.top + l.top
                                ? h = !0
                                ...
                                (g = t("div",
                                    ...
                                    "px; left: " +
                                    g.left +
                                    "px; width: 2px;"), c.display.lineSpace.appendChild(g), g.scrollIntoView(h), c
                                    .display.lineSpace.removeChild(g))))
                    }
    ...
    function Q(a, b, c, d) {
        ...
        if (b >= e.viewTo) ra && Mc(a.doc, b) < e.viewTo && qa(a);
            ...
            f && g
                ? (e.view =
                    e.view.slice(0, f.index).concat(Nb(a, f.lineN, g.lineN)).concat(e.view.slice(g.index)), e.viewTo +=
                    d)
                : qa(a)
        }
    ...
    function sf(a) {
        function b() {
            d.activeTouch &&
                (e = setTimeout(function() { d.activeTouch = null }, 1E3), f = d.activeTouch, f.end = +new Date)
        }
        ...
        v(d.scroller,
            ...
            function(a) {
                ...
                b ||
                (clearTimeout(e), b = +new Date, d.activeTouch =
                    { start: b, moved: !1, prev: 300 >= b - f.end ? f : null }, 1 == a.touches.length &&
        ...
        d.dragFunctions = {
            ...
            start: function(b) {
                if (B && (!a.state.draggingText || 100 > +new Date - se)) jd(b);
                    ...
                    !oa(a.display, b) &&
                    (b.dataTransfer.setData("Text", a.getSelection()), b.dataTransfer.setDragImage &&
                        !te)) {
    ...
    function oa(a, b) {
        for (var c = b.target || b.srcElement; c != a.wrapper; c = c.parentNode)
            if (!c ||
                ...
                c.parentNode == a.sizer && c != a.mover) return!0
    }
    ...
    function Ua(a, b, c, d) {
        ...
        d &&
            ...
            (d = aa(k, k.length, a.options.tabSize) - k.length, b = r(b.line,
    ...
    function pe(a) {
        ...
        if (!(b.activeTouch && b.input.supportsTouch() || ja(this, a)))
            if (b.shift = a.shiftKey, oa(b, a))
                J || (b.scroller.draggable = !1, setTimeout(function() { b.scroller.draggable = !0 }, 100));
            else if (!hd(this,
                a,
                "gutterClick",
                !0,
        ...
        var e = a.display,
            ...
            g = G(a,
                function(h) {
                    ...
                    (O(h), !d && +new Date - 200 < f && Ub(a.doc, c), J || B && 9 == C
                        ? setTimeout(function() {
                                document.body.focus();
                                e.input.focus()
                            },
    ...
    function Nf(a, b, c, d, e) {
                ...
                if (x = b, "rect" == d) {
                    ...
                    (b = "double" == d ? a.findWordAt(b) : new z(r(b.line, 0), w(l, r(b.line + 1, 0))),
                        0 < y(b.anchor, f)
                            ...
                            : (k = b.anchor, f = Pb(e.to(), b.head))), e = n.ranges.slice(0), e[p] =
                        new z(w(l, f), k), H(l, Z(e, p), kd)
        }
        ...
        function g(b) {
            ...
            if (e)
                if (0 != y(e, x)) {
                    ...
                    (e.line >= h.to ||
                            e.line < h.from) &&
                        setTimeout(G(a, function() { A == c && g(b) }), 150)
                } else {
        ...
        if (b.altKey)
            ...
            "triple" == d
                ? (t = new z(r(c.line, 0), w(l, r(c.line + 1, 0))), m =
                    a.display.shift || l.extend ? rb(l, m, t.anchor, t.head) : t)
                : m = rb(l, m, c);
        e
            ? -1 == p
        ...
        if (!ja(b, a) && !oa(b.display, a)) {
            ...
            if (c && !Rb(b))
                if (d && d.length && window.FileReader && window.File) {
                    ...
                    -1 < b.doc.sel.contains(c))
                    b.state.draggingText(a), setTimeout(function() { b.display.input.focus() }, 20);
                else
                    try {
    ...
    function lb(a, b) {
        ...
        (a.doc.scrollTop = b, wa || Pc(a, { top: b }), a.display.scroller.scrollTop != b &&
    ...
    function Ma(a, b, c) {
        ...
        (b = Math.min(b, a.display.scroller.scrollWidth - a.display.scroller.clientWidth), a.doc.scrollLeft =
            b, Bc(a), a.display.scroller.scrollLeft != b && (a.display.scroller.scrollLeft = b), a.display.scrollbars
            .setScrollLeft(b))
    }
    ...
    function re(a, b) {
        ...
        if (d && f.scrollWidth > f.clientWidth || c && f.scrollHeight > f.clientHeight) {
            ...
            !d || wa || ba || null == R
                ? (c &&
                    null != R &&
                    (g = c * R, h = a.doc.scrollTop, k =
                        h + e.wrapper.clientHeight, 0 > g
                        ? h = Math.max(0, h + g - 50)
                        : k = Math.min(a.doc.height, k + g + 50), Pc(a, { top: h, bottom: k })), 20 > gc &&
                (null == e.wheelStartX
                    ? (e.wheelStartX = f.scrollLeft, e.wheelStartY = f.scrollTop, e.wheelDX = d, e.wheelDY =
                ...
                : (c && lb(a, Math.max(0, Math.min(f.scrollTop + c * R, f.scrollHeight - f.clientHeight))), Ma(a,
                    Math.max(0, Math.min(f.scrollLeft + d * R, f.scrollWidth - f.clientWidth))), O(b), e.wheelStartX =
                    null)
        }
    }
    ...
    function Be(a, b) {
        ...
        return c
            ...
            ? jc(a, "Shift-" + c, b, function(b) { return hc(a, b, !0) }) ||
            jc(a, c, b, function(b) { if ("string" == typeof b ? /^go[A-Z]/.test(b) : b.motion) return hc(a, b) })
            : jc(a, c, b, function(b) { return hc(a, b) })
            : !1
    }
    ...
    function xc(a) {
        ...
        (a.state.focused ||
        (K(a, "focus", a), a.state.focused = !0, mb(a.display.wrapper, "CodeMirror-focused"), a.curOp ||
            a.display.selForContextMenu == a.doc.sel ||
            (a.display.input.reset(), J && setTimeout(function() { a.display.input.reset(!0) }, 20)), a.display.input
            .receivedFocus()), Yc(a))
    }
    ...
    function Le(a, b) {
        if (0 != b &&
        (a.first += b, a.sel = new la(ob(a.sel.ranges,
                function(a) {
                    return new z(r(a.anchor.line + b, a.anchor.ch),
                        r(a.head.line +
                            b,
                            a.head.ch))
                }),
    ...
    function Vf(a, b, c) {
        ...
        a.options.lineWrapping ||
            (k = F(ia(u(d, f.line))), d.iter(k, g.line + 1, function(a) { if (a == e.maxLine) return h = !0 }));
        -1 < d.sel.contains(b.from, b.to) && fe(a);
        qd(d, b, c, Id(a));
        a.options.lineWrapping ||
        (d.iter(k,
            f.line + b.text.length,
            function(a) {
                var b = Kb(a);
                b > e.maxLineLength &&
                (e.maxLine =
        ...
        c = S(a, "changes");
        if ((d = S(a, "change")) || c)
            b = { from: f, to: g, text: b.text, removed: b.removed, origin: b.origin }, d && L(a, "change", a, b), c &&
                (a.curOp.changeObjs || (a.curOp.changeObjs = [])).push(b);
    ...
    function Pe(a, b, c, d) {
        ...
        "page" == d
            ? (g =
                    Math.min(a.display.wrapper.clientHeight,
                        window.innerHeight || document.documentElement.clientHeight),
                g = b.top + c * (g - (0 > c ? 1.5 : .5) * xa(a.display)))
    ...
    function Wa(a, b, c, d, e) {
        ...
        f.replacedWith &&
        (f.collapsed = !0, f.widgetNode =
            t("span", [f.replacedWith], "CodeMirror-widget"), d.handleMouseEvents ||
    ...
    function od(a, b) {
        ...
        if (d)
            for (var h = 0, n; h < d.length; ++h)
                if (k = d[h], l =
                    ...
                    m = null == k.from || (l.inclusiveLeft ? k.from <= f : k.from < f), (n || (n = [])).push(new qc(l,
                        m ? null : k.from - f,
        ...
        if (d)
            for (f = 0; f < d.length; ++f)
                h = d[f], null != h.to && (h.to += n), null == h.from
    ...
    function td(a, b, c) {
        ...
        for (var d, e = 0; e < b.markedSpans.length; ++e)
            if (d = b.markedSpans[e], d.marker.collapsed &&
                !d.marker.widgetNode &&
                d.from == c.to &&
    ...
    function $f(a, b, c, d) {
        ...
        nc(a,
            ...
            function(b) {
                ...
                f &&
                    !ya(a, b) &&
                    (c = ea(b) < a.scrollTop, ca(b, b.height + ub(e)),
                    ...
                    for (var p = l.length,
                        ...
                        if (w == n) {
                            for (var x = y = A = C = v = "", z = null, w = Infinity, G = [], H = 0; H < k.length; ++H) {
                                ...
                                "bookmark" == D.type && I.from == n && D.widgetNode
                                    ...
                                    ? (null != I.to && I.to != n && w > I.to && (w = I.to, y = ""), D.className &&
                                            (x += " " + D.className), D.css && (v = D.css),
                                        D.startStyle && I.from == n && (A += " " + D.startStyle),
                                        D.endStyle && I.to == w && (y += " " + D.endStyle),
                                        D.title && !C && (C = D.title), D.collapsed &&
                                            (!z || 0 > Ve(z.marker, D)) &&
                                            (z = I))
                        ...
                        for (G = Math.min(p, w);;) {
                            if (r) {
                                H = n + r.length;
                                z ||
                                (I = H > G ? r.slice(0, G - n) : r, g.addToken(g,
                                    I,
                                    u ? u + x : x,
                                    A,
                                    n + I.length == w ? y : "",
        ...
        if (b) {
            ...
            if (k.test(b))
                for (var m = document.createDocumentFragment(), p = 0;;) {
                    ...
                    p += q + 1;
                    "\t" == n[0]
                        ? (r = a.cm.options.tabSize, n = r - a.col % r, r =
                                m.appendChild(t("span", Ne(n), "cm-tab")), r.setAttribute("role", "presentation"),
                            r.setAttribute("cm-text", "\t"), a.col += n)
                        : (r = a.cm.options.specialCharPlaceholder(n[0]), r.setAttribute("cm-text", n[0]), B && 9 > C
                            ? m.appendChild(t("span", [r]))
                            : m.appendChild(r), a.col += 1);
            ...
            if (c || d || e || l || g)
                return b = c || "", d && (b += d), e && (b += e), d =
                    t("span", [m], b, g), f && (d.title = f), a.content.appendChild(d);
    ...
    function qd(a, b, c, d) {
        ...
        if (b.full) a.insert(0, f(0, k.length)), a.remove(k.length, a.size - k.length);
            ...
            l == m
                ...
                : (r =
                        f(1, k.length - 1), r.push(new Ab(p + l.text.slice(h.ch), n, d)),
                    e(l, l.text.slice(0, g.ch) + k[0], c ? c[0] : null), a.insert(g.line + 1, r))
                : 1 == k.length
                ? (e(l, l.text.slice(0, g.ch) + k[0] + m.text.slice(h.ch), c ? c[0] : null), a.remove(g.line + 1, q))
                : (e(l, l.text.slice(0, g.ch) + k[0], c ? c[0] : null), e(m, p + m.text.slice(h.ch), n), r =
                    f(1, k.length - 1), 1 < q && a.remove(g.line + 1, q - 1), a.insert(g.line + 1, r));
        L(a, "change", a, b)
    }
    ...
    function Ie(a, b, c, d) {
        ...
        if (h) {
            ...
            for ((g = A(e.done)) && g.ranges || Wb(a.sel, e.done), g =
                    { changes: [pd(a, b)], generation: e.generation }, e.done.push(g);
    ...
    function ld(a) { return null != a.defaultPrevented ? a.defaultPrevented : 0 == a.returnValue }
    ...
    function ja(a, b, c) {
        "string" ==
            typeof b &&
            (b = { type: b, preventDefault: function() { this.defaultPrevented = !0 } });
        K(a, c || b.type, a, b);
    ...
    Fc.prototype = V({
            update: function(a) {
                var b =
                    ...
                    d = a.nativeBarWidth;
                c
                    ? (this.vert.style.display = "block", this.vert.style.bottom =
                        b ? d + "px" : "0", this.vert.firstChild.style.height =
                        Math.max(0, a.scrollHeight - a.clientHeight + (a.viewHeight - (b ? d : 0))) + "px")
                    : (this.vert.style.display = "", this.vert.firstChild.style.height = "0");
                b
                    ? (this.horiz.style.display = "block", this.horiz.style.right =
                        c ? d + "px" : "0", this.horiz.style.left =
                        a.barLeft + "px", this.horiz.firstChild.style.width =
                        a.scrollWidth -
                        a.clientWidth +
                        (a.viewWidth -
                            a.barLeft -
    ...
    Tc.prototype = V({
            init: function(a) {
                function b(a) {
                    if (d.somethingSelected())
                        X = d.getSelections(), c.inaccurateSelection &&
                ...
                v(f,
                    "compositionend",
                    function() { c.composing && (c.poll(), c.composing.range.clear(), c.composing = null) })
            },
            ...
            showSelection: function(a) {
                ...
                null != a.teTop &&
                (this.wrapper.style.top = a.teTop + "px", this.wrapper.style.left =
                    a.teLeft + "px")
            },
            reset: function(a) {
                if (!this.contextMenuPending) {
                    ...
                    d.somethingSelected()
                        ? (this.prevInput = "", b = e.sel.primary(), c =
                            (b = Ce && (100 < b.to().line - b.from().line || 1E3 < (c = d.getSelection()).length))
                            ? "-"
                            : c || d.getSelection(), this.textarea.value =
                            c, d.state.focused && Za(this.textarea), B && 9 <= C && (this.hasSelection = c))
            ...
            slowPoll: function() {
                var a = this;
                a.pollingFast ||
                    a.polling.set(this.cm.options.pollInterval,
                        function() {
                            a.poll();
            ...
            poll: function() {
                ...
                T(a,
                    function() {
                        ...
                        g.composing &&
                        (g.composing.range.clear(), g.composing.range = a.markText(g.composing.start,
                            a.getCursor("to"),
            ...
            onContextMenu: function(a) {
                ...
                function c() {
                    ...
                    B &&
                        9 > C &&
                        f.scrollbars.setScrollTop(f.scroller.scrollTop =
                            k);
                    if (null != g.selectionStart) {
                        (!B || B && 9 > C) && b();
                        var a = 0,
                ...
                if (h && !ba) {
                    ...
                    d.wrapper.style.position =
                        "absolute";
                    g.style.cssText = "position: fixed; width: 30px; height: 30px; top: " +
                        (a.clientY - 5) +
                        "px; left: " +
                        (a.clientX - 5) +
    ...
    Uc.prototype = V({
            init: function(a) {
                function b(a) {
                    ...
                    if (a.clipboardData && !Qa)
                        a.preventDefault(), a.clipboardData.clearData(),
            ...
            showPrimarySelection: function() {
                ...
                if (!c || c.bad || !d || d.bad || 0 != y(Qb(c, d), b.from()) || 0 != y(Pb(c, d), b.to()))
                    if (c = Yd(this.cm, b.from()), d = Yd(this.cm, b.to()), c || d) {
                        ...
                        f &&
                        (a.removeAllRanges(), a.addRange(f), b && null == a.anchorNode
                            ? a.addRange(b)
            ...
            receivedFocus: function() {
                ...
                this.selectionInEditor()
                    ? this.pollSelection()
                    : T(this.cm, function() { b.cm.curOp.selectionChanged = !0 });
            ...
            pollContent: function() {
                ...
                for (var g = 0, f = 0, h = b[0], k = e[0], l = Math.min(h.length, k.length);
                    g < l && h.charCodeAt(g) == k.charCodeAt(g);
                ) ++g;
                h = A(b);
                k = A(e);
                for (l = Math.min(h.length - (1 == b.length ? g : 0), k.length - (1 == e.length ? g : 0));
                    f < l &&
            ...
            forceCompositionEnd: function() {
                this.composing &&
                    ...
                    (this.applyComposition(this.composing), this.composing.handled =
                        !0, this.div.blur(), this.div.focus())
            },
    ...
    la.prototype = {
        ...
        equals: function(a) {
            ...
            if (a.primIndex !=
                this.primIndex ||
                a.ranges.length != this.ranges.length) return!1;
    ...
    z.prototype = {
        from: function() { return Qb(this.anchor, this.head) },
        to: function() { return Pb(this.anchor, this.head) },
    ...
    q.prototype = {
        ...
        indentSelection: M(function(a) {
            for (var b = this.doc.sel.ranges, c = -1, d = 0; d < b.length; d++) {
                ...
                if (e.empty())
                    e.head.line > c &&
                        (pb(this, e.head.line, a, !0), c = e.head.line, d == this.doc.sel.primIndex && Pa(this));
                else {
                    for (var f = e.from(),
                        e = e.to(),
                        g = Math.max(c, f.line),
        ...
        heightAtLine: function(a, b) {
            var c = !1, d;
            "number" == typeof a
                ? (d = this.doc.first + this.doc.size - 1, a < this.doc.first
                    ? a = this.doc.first
                    : a > d && (a = d, c = !0), d = u(this.doc,
                    a))
                : d = a;
        ...
        addWidget: function(a, b, c, d, e) {
            ...
            (a = cc(this, h, g, h + b.offsetWidth, g + b.offsetHeight),
                null != a.scrollTop && lb(this, a.scrollTop), null != a.scrollLeft && Ma(this, a.scrollLeft))
        },
        ...
        findWordAt: function(a) {
            ...
            if (b) {
                ...
                for (var f = b.charAt(c),
                    f = oc(f, e)
                        ? function(a) { return oc(a, e) }
                        : /\s/.test(f)
                        ? function(a) { return/\s/.test(a) }
                        : function(a) { return!/\s/.test(a) && !oc(a) };
                    0 < c && f(b.charAt(c - 1));
                ) --c;
        ...
        toggleOverwrite: function(a) {
            if (null ==
                a ||
                a != this.state.overwrite)
                (this.state.overwrite = !this.state.overwrite)
                    ? mb(this.display.cursorDiv, "CodeMirror-overwrite")
                    : kb(this.display.cursorDiv, "CodeMirror-overwrite"), K(this,
                    "overwriteToggle",
                    this,
        ...
        scrollIntoView: M(function(a, b) {
            null == a
                ? (a =
                    { from: this.doc.sel.primary().head, to: null }, null == b && (b = this.options.cursorScrollMargin))
                : "number" == typeof a
    ...
    var qf = q.defaults = {},
        Ka = q.optionHandlers = {},
        Fd = q.Init = { toString: function() { return"CodeMirror.Init" } };
    ...
    x("inputStyle",
        ...
        function() { throw Error("inputStyle can not (yet) be changed in a running editor"); },
        !0);
    ...
    x("dragDrop",
        ...
        function(a, b, c) {
            !b != !(c && c != q.Init) &&
            (c = a.display.dragFunctions, b =
                    b ? v : ka, b(a.display.scroller, "dragstart", c.start), b(a.display.scroller,
                    "dragenter",
                    c.simple),
                b(a.display.scroller, "dragover", c.simple), b(a.display.scroller, "drop", c.drop))
        });
    ...
    var Sa = q.copyState = function(a, b) {
        ...
        Df = q.startState = function(a, b, c) { return a.startState ? a.startState(b, c) : !0 };
    ...
    var ic = q.commands = {
            ...
            deleteLine: function(a) {
                Va(a, function(b) { return{ from: r(b.from().line, 0), to: w(a.doc, r(b.to().line + 1, 0)) } })
            },
            ...
            goLineStart: function(a) {
                a.extendSelectionsBy(function(b) { return kf(a, b.head.line) }, { origin: "+move", bias: 1 })
            },
                        ...
                        for (var b = a.listSelections(), c = [], d = 0; d < b.length; d++) {
                            ...
                            if (f)
                                if (e.ch == f.length && (e = new r(e.line, e.ch - 1)), 0 < e.ch)
                                    e = new r(e.line, e.ch + 1), a.replaceRange(f.charAt(e.ch - 1) + f.charAt(e.ch - 2),
                                        r(e.line, e.ch - 2),
                                        e,
                                        "+transpose");
    ...
    tc.prototype = {
        ...
        column: function() {
            ...
            (this.lastColumnValue =
                    aa(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue),
                this.lastColumnPos = this.start);
            return this.lastColumnValue - (this.lineStart ? aa(this.string, this.lineStart, this.tabSize) : 0)
        },
        indentation: function() {
            return aa(this.string, null, this.tabSize) -
        ...
        if (!this.explicitlyCleared) {
            ...
            if (a && this.collapsed && !a.options.lineWrapping)
                for (e = 0; e < this.lines.length; ++e)
                    f = ia(this.lines[e]), g = Kb(f), g > a.display.maxLineLength &&
                ...
                if (a <= f) {
                    ...
                    if (e.lines && 50 < e.lines.length) {
                        for (; 50 < e.lines.length;)
                            a = e.lines.splice(e.lines.length - 25, 25), a =
                                new Bb(a), e.height -= a.height, this.children.splice(d + 1, 0, a), a.parent = this;
                        this.maybeSpill()
                    }
                    break
                }
    ...
    for (Jb in P.prototype)
        P.prototype.hasOwnProperty(Jb) &&
            0 > D(pg, Jb) &&
            (q.prototype[Jb] =
                function(a) { return function() { return a.apply(this.doc, arguments) } }(P.prototype[Jb]));
    Ya(P);
    ...
    var rg =
            /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
        gf = q.isWordChar =
            function(a) { return/\w/.test(a) || "" < a && (a.toUpperCase() != a.toLowerCase() || rg.test(a)) },
        ig =
