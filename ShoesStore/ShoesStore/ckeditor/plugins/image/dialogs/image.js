        ...
        return{
            ...
            onOk: function() {
                if (this.imageEditMode) {
                    ...
                    "image" == k
                        ...
                        : (this.imageElement =
                            d.document.createElement("input"), this.imageElement.setAttribute("type", "image")), this
            ...
            onHide: function() {
                ...
                (this.originalElement.removeListener("load",
                        t), this.originalElement.removeListener("error", f),
                                    ...
                                    children: [
                                        {
                                            ...
                                            onChange: function() {
                                                ...
                                                if (0 <
                                                    ...
                                                    a.preview &&
                                                    (w.setAttribute("src", b), a.preview.setAttribute("src",
                                                        w.$.src), e(a))
                                                } else
                                                    a.preview &&
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            validate: function() {
                                                                var a = this.getValue().match(y);
                                                                (a = !(!a || 0 === parseInt(a[1], 10))) ||
                                                                    alert(d.lang.common.invalidLength.replace("%1",
