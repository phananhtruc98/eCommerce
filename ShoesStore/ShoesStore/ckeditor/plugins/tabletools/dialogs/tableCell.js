    ...
    function(f) {
        ...
        function e(a) {
            return function(b) {
                ...
                "undefined" != typeof k &&
                (this.setValue(k), CKEDITOR.env.gecko &&
                    "select" == this.type &&
                    !k &&
        ...
        var l = f.lang.table,
            ...
            d = [
                {
                    ...
                    children: [
                        {
                            ...
                            onLoad: function() {
                                ...
                                this.getDialog().getContentElement("info", "height").isVisible() &&
                                    (a.setHtml("\x3cbr /\x3e" + l.widthPx), a.setStyle("display", "block"));
                                b.setAttribute("aria-labelledby", [c, a.$.id].join(" "))
                            },
                            setup: e(function(a) {
                                var b =
                    ...
                    "default": "",
                    items: [
                        [d.notSet, ""], [d.left, "left"], [d.center, "center"], [d.right, "right"],
                        [d.justify, "justify"]
                    ],
                    setup: e(function(a) {
                    ...
                    "default": "",
                    items: [
                        [d.notSet, ""], [d.alignTop, "top"], [d.alignMiddle, "middle"], [d.alignBottom, "bottom"],
                ...
                }, h(["td{text-align}", "td{vertical-align}"]),
                {
                    ...
                    setup: e(function(a) { return a.getName() }),
            ...
            t = -1,
            g = [q()],
            d = CKEDITOR.tools.array.filter(d,
                function(a) {
                ...
                this.foreach(function(b) {
                    b.setup &&
                        ...
                        (b.setup = CKEDITOR.tools.override(b.setup,
                            ...
                            function(c) { return function() { a[b.id] !== b.getValue() && c.apply(this, arguments) } }))
                })
            }
        }
    });