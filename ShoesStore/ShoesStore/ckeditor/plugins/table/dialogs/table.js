        ...
        return{
            ...
            onShow: function() {
                ...
                ((e = e.getSelectedElement()) && e.is("table")
                    ? b = e
                    : 0 < d.length &&
                    (CKEDITOR.env.webkit && d[0].shrink(CKEDITOR.NODE_ELEMENT), b =
                        a.elementPath(d[0].getCommonAncestor(!0)).contains("table", 1)), this._.selectedElement = b);
                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                        ...
                                        },
                                        {
                                            ...
                                            setup: function(e) { this.setValue(w(e)) },
                                            commit: n
                                        ...
                                        if (this.isEnabled()) {
                                            ...
                                            if (b)
                                                0 < c.count()
                                                    ...
                                                    : (c = new CKEDITOR.dom.element("caption", a.document), d.append(c,
