...
(function() {
    ...
    CKEDITOR.cleanWord = function(a, b) {
        function c(a) { (a.attributes["o:gfxdata"] || "v:group" === a.parent.name) && e.push(a.attributes.id) }

        var d = Boolean(a.match(/mso-list:\s*l\d+\s+level\d+\s+lfo\d+/)), e = [];
            ...
            f = {
                ...
                elements: {
                    ...
                    img: function(a) {
                        ...
                        k.mapStyles(a,
                            {
                                width: function(b) { k.setStyle(a, "width", b + "px") },
                                height: function(b) { k.setStyle(a, "height", b + "px") }
                            });
                        a.attributes.src &&
                    ...
                    td: function(a) {
                        ...
                        var c = m.parseCssText(a.attributes.style), h;
                    ...
                    "v:shape": function(a) {
                        ...
                        if (null === a.getFirst("v:imagedata")) c(a);
                            ...
                            "v:group" === a.parent.name
                                ? c(a)
                                : (a.forEach(function(a) { a.attributes && a.attributes.src && (d = a.attributes.src) },
                                    CKEDITOR.NODE_ELEMENT,
                                    !0), a.filterChildren(p), a.name = "img", a.attributes.src =
                                    a.attributes.src || d, delete a.attributes.type)
                        }
                    },
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        normalizedStyles: function(a, b) {
            ...
            (f["TEXT-INDENT"] && f.MARGIN
                    ? (a.attributes["cke-indentation"] = g.getElementIndentation(a), f.MARGIN =
                        f.MARGIN.replace(/(([\w\.]+ ){3,3})[\d\.]+(\w+$)/, "$10$3"))
                    : delete f["TEXT-INDENT"],
                delete f["text-indent"]);
            for (var l = m.objectKeys(f), q = 0; q < l.length; q++) {
                var n = l[q].toLowerCase(), r = f[l[q]], k = CKEDITOR.tools.indexOf;
        ...
        sortStyles: function(a) {
            for (var b = ["border", "border-bottom", "font-size", "background"],
                ...
                f = 0;
                f < d.length;
                f++) -1 !== m.indexOf(b, d[f].toLowerCase()) ? e.push(d[f]) : h.push(d[f]);
            e.sort(function(a, c) {
        ...
        inliner: {
            ...
            filter: function(a) {
                var b = CKEDITOR.plugins.pastefromword.styles.inliner.filtered, c = m.array.indexOf, d = {}, e;
            ...
            inline: function(a) {
                ...
                CKEDITOR.tools.array.forEach(c,
                    function(a) {
                        ...
                        w(b);
                        for (q = 0; q < a.count(); q++)
                            c = a.getItem(q), g = CKEDITOR.tools.parseCssText(c.getAttribute("style")), w(g), g =
                                CKEDITOR.tools.extend({}, g, b), c.setAttribute("style", CKEDITOR.tools.writeCssText(g))
                    });
                return d
            }
        }
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        removeSymbolText: function(a) {
            ...
            a.forEach(function(e) {
                    !d &&
                        -1 < e.value.indexOf(b) &&
                        (d = !0, e.value = e.value.replace(b, ""), e.parent.getHtml().match(/^(\s|&nbsp;)*$/)
        ...
        setListSymbol: function(a, b, c) {
            ...
            if ("ol" == a.name) {
                ...
                e = { "·": "disc", o: "circle", "§": "square" }, !d["list-style-type"] &&
                    e[b] &&
                ...
                function c(a) {
                    ...
                    for (var b = 1, c = 1; 0 < a.length; c *= 26)
                        b += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length -
                                1)) *
                            c, a = a.substr(0, a.length - 1);
                    return b
                }

                function d(a) {
                    var b = [
                        [1E3, "M"], [900, "CM"], [500, "D"], [400, "CD"], [100, "C"], [90, "XC"], [50, "L"], [40, "XL"],
        ...
        createLists: function(a) {
            ...
            for (a = 0; a < h.length; a++) {
                ...
                var l = [g.createList(l)], k = l[0], n = [l[0]];
                k.insertBefore(f[0]);
                for (d = 0;
                    d <
                        f.length;
                    ...
                    for (c = b.attributes["cke-list-level"]; c > l.length;) {
                        var r = g.createList(b), m = k.children;
                        0 < m.length
                            ? m[m.length - 1].add(r)
                            : (m =
                                new CKEDITOR.htmlParser.element("li", { style: "list-style-type:none" }), m.add(r), k
                                .add(m));
                        l.push(r);
                        n.push(r);
                        k = r;
                    ...
                    for (; c < l.length;)
                        l.pop(), k =
                            l[l.length - 1], c == l.length && g.setListSymbol(k, b.attributes["cke-symbol"], c);
                    b.remove();
                    k.add(b)
                }
                l[0].children.length &&
                (d = l[0].children[0].attributes["cke-symbol"],
                    !d && 1 < l[0].children.length && (d = l[0].children[1].attributes["cke-symbol"]), d &&
                        g.setListSymbol(l[0], d));
        ...
        cleanup: function(a) {
            var b = ["cke-list-level", "cke-symbol", "cke-list-id", "cke-indentation", "cke-dissolved"], c, d;
        ...
        determineListItemValue: function(a) {
            if ("ol" === a.parent.name) {
                ...
                c &&
                (c = c[c.length - 1], d =
                    a.parent.attributes["cke-list-style-type"] || this.numbering.getStyle(c), c =
                    this.numbering.toNumber(c, d), c !== b && (a.attributes.value = c))
            }
        },
        ...
        dissolveList: function(a) {
            ...
            h.forEach(n,
                function(a) {
                    ...
                    h.forEach(h.filter(a.children, d("li")),
                        function(c, d) {
                            var e;
                            switch (f) {
                            case "disc":
        ...
        groupLists: function(a) {
            ...
            for (b = 1; b < a.length; b++) {
                ...
                c.previous !==
                    h &&
                    (g.chopDiscontinuousLists(e, d), d.push(e = []));
                e.push(c)
            }
        ...
        chopDiscontinuousLists: function(a, b) {
            for (var c = {}, d = [[]], e, h = 0; h < a.length; h++) {
                var f = c[a[h].attributes["cke-list-level"]], l = this.getListItemInfo(a[h]), k, n;
                f
                    ? (n = f.type.match(/alpha/) && 7 == f.index ? "alpha" : n, n =
                        "o" == a[h].attributes["cke-symbol"] && 14 == f.index ? "alpha" : n, k =
                        g.getSymbolInfo(a[h].attributes["cke-symbol"], n), l =
                        this.getListItemInfo(a[h]), (f.type != k.type ||
        ...
        getListItemInfo: function(a) {
            ...
            var b = m.parseCssText(a.attributes.style)["mso-list"], c = { id: "0", level: "1" };
    ...
    CKEDITOR.plugins.pastefromword.heuristics = {
            ...
            return!!b.attributes["cke-list-level"] ||
                ...
                !!b.find(function(a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT &&
                            b.name.match(/h\d/i) &&
                            a.getHtml().match(/^[a-zA-Z0-9]+?[\.\)]$/)) return!0;
        ...
        assignListLevels: function(a, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                for (var c = [g.getElementIndentation(b)], d = [b], e = [], h = CKEDITOR.tools.array, f = h.map;
                    b.next &&
                        b.next.attributes &&
                ...
                var k = f(c, function(a, b) { return 0 === b ? 0 : a - c[b - 1] }),
                    ...
                    e = f(c, function(a) { return Math.round(a / m) });
                -1 !== h.indexOf(e, 0) && (e = f(e, function(a) { return a + 1 }));
        ...
        correctLevelShift: function(a) {
            if (this.isShifted(a)) {
                var b = CKEDITOR.tools.array.filter(a.children,
                        function(a) {
                            return"ul" ==
                                a.name ||
                                "ol" == a.name
                        }),
                    c = CKEDITOR.tools.array.reduce(b,
                        function(a, b) {
                            return(b.children && 1 == b.children.length && t.isShifted(b.children[0])
                                    ? [b]
                                    : b.children)
                                .concat(a)
                        },
        ...
        isShifted: function(a) {
            return"li" !== a.name
                ? !1
                : 0 ===
                CKEDITOR.tools.array.filter(a.children,
                    function(a) {
