        ...
        return{
            ...
            onOk: function() {
                ...
                this._.selectedElement
                    ...
                    ? (b =
                            e(c, a), b.replace(this._.selectedElement), CKEDITOR.env.ie &&
                    ...
                    : (b = (b = c.getSelection()) && b.getRanges()[0], b.collapsed
                        ...
                        : (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (a["class"] = "cke_anchor"), a =
                            new CKEDITOR.style({ element: "a", attributes: a }), a.type =
                            CKEDITOR.STYLE_INLINE, a.applyToRange(b)))
            },
