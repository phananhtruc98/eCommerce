                        ...
                        elements: [
                            {
                                ...
                                onChange: function() {
                                    ...
                                    for (f = 0; f < b.length; f++) {
                                        ...
                                        h &&
                                        (h = h.getElement().getParent().getParent(), b[f] == r + "Options"
                                            ? h.show()
                                            : h.hide())
                                    }
                                    a.layout()
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [g.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"],
                                            [g.targetNew, "_blank"], [g.targetTop, "_top"], [g.targetSelf, "_self"],
                ...
                onOk: function() {
                    ...
                    if (this._.selectedElements.length) {
                        ...
                        for (l = 0; l < g.length; l++) {
                            d = g[l];
                            d.collapsed
                                ? (e = new CKEDITOR.dom.text(a.linkText ||
