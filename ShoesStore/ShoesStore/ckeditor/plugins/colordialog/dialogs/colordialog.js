    ...
    function(x) {
        ...
        function z(a) {
            ...
            "td" == a.getName() &&
                ...
                (y(), f = a, f.setAttribute("aria-selected", !0), f.addClass("cke_colordialog_selected"), p
        ...
        function A(a) {
            ...
            var c = !/mouse/.test(a.name), b = a.data.getTarget(), k;
            "td" == b.getName() &&
                (k = b.getChild(0).getHtml()) &&
                (q(a), c ? d = b : B = b, c &&
                    b.addClass(D(k) ? "cke_colordialog_focused_light" : "cke_colordialog_focused_dark"), r(k))
        }
        ...
        function E(a) {
            var c = a.data, b = c.getTarget(), k = c.getKeystroke(), d = "rtl" == x.lang.dir;
            switch (k) {
            case 38:
                            ...
                            children: [
                                {
                                    ...
                                    onLoad: function() { CKEDITOR.document.getById(this.domId).append(h) },
                                    focus: function() {
