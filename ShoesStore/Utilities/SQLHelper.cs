...
namespace Utilities
{
    public class SQLHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = ConfigurationManager.ConnectionStrings["strConnection"].ConnectionString;
        ...
        {
            string strConnect = ConfigurationManager.ConnectionStrings["strConnection"].ConnectionString.ToString();
            SqlConnection con = new SqlConnection(strConnect);
            SqlDataAdapter CmdObj = new SqlDataAdapter(sqlQry, con);
            DataSet DsObj = new DataSet();
            CmdObj.Fill(DsObj, sqlQry);
            DataTable dt = DsObj.Tables[0];
            CmdObj.Dispose();
            con.Close();
            return dt;
        }
        ...
        {
            string strConnect = ConfigurationManager.ConnectionStrings["strConnection"].ConnectionString.ToString();
            DataTable dt = ExecuteDataset(strConnect, CommandType.Text, sqlQry, param).Tables[0];
            return dt;
        }
        ...
        {
            string strConnect = ConfigurationManager.ConnectionStrings["strConnection"].ConnectionString.ToString();
            SqlConnection conn = GetConnection(strConnect);
